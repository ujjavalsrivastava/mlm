  ...
  q.prototype = {
    ...
    append: function () {
      ...
      this.$cache.cont.html(
        '<span className="irs"><span className="irs-line" tabindex="0"><span className="irs-line-left"></span><span className="irs-line-mid"></span><span className="irs-line-right"></span></span><span className="irs-min">0</span><span className="irs-max">1</span><span className="irs-from">0</span><span className="irs-to">0</span><span className="irs-single">0</span></span><span className="irs-grid"></span><span className="irs-bar"></span>'
      );
      ...
      "single" === this.options.type
        ? (this.$cache.cont.append(
            '<span className="irs-bar-edge"></span><span className="irs-shadow shadow-single"></span><span className="irs-slider single"></span>'
          ),
        ...
        : (this.$cache.cont.append(
            '<span className="irs-shadow shadow-from"></span><span className="irs-shadow shadow-to"></span><span className="irs-slider from"></span><span className="irs-slider to"></span>'
          ),
    ...
    appendGrid: function () {
      if (this.options.grid) {
        ...
        for (d = 0; d < c + 1; d++) {
          ...
          g +=
            '<span className="irs-grid-pol" style="left: ' + h + '%"></span>';
