      ...
      typeof window == y
        ...
        : (a(document, "addEventListener") &&
          ...
          H.createCoreModule("DomUtil", [], function (a, b) {
            ...
            function n(a, b, c) {
              var d,
                ...
                g = a.cloneNode(!1);
              if (
                (g.deleteData(0, b), a.deleteData(b, a.length - b), m(g, a), c)
              )
                for (d = 0; (f = c[d++]); )
                  f.node == a && f.offset > b
                    ? ((f.node = g), (f.offset -= b))
          ...
          H.createCoreModule("DomRange", ["DomUtil"], function (a) {
            ...
            function v(a) {
              return (
                (ob && ab.isBrokenNode(a)) || (!mb(J, a.nodeType) && !N(a, !0))
              );
            }
            function w(a, b) {
            ...
            a.features.implementsDomRange &&
              ...
              a.features.implementsTextRange &&
                ...
                (!a.features.implementsDomRange || a.config.preferTextRange) &&
                  ...
                  (a.createNativeRange = function (a) {
                    return (
                      (a = p(a, b, "createNativeRange")), o(a).createTextRange()
                    );
                  }),
                  (a.WrappedRange = d))),
            ...
            function (a, b) {
              ...
              function x(a) {
                var b,
                  ...
                  g =
                    "function" == typeof a.getName ? a.getName() : "Selection";
                    ...
                    ? function (b, d) {
                        ...
                        $ && P && this.docSelection.type == K
                          ...
                          : (X
                            ...
                            this.nativeSelection.addRange(k(b).cloneRange()),
              ...
              e === this.contain
                ...
                : (e && 3 !== e.nodeType && 1 !== e.nodeType
                    ...
                    : c &&
                      e &&
                      1 === e.nodeType &&
                      !a.lang.array(["BR", "HR", "IMG"]).contains(e.nodeName) &&
                      /^[\s]*$/.test(e.innerHTML)
                    ? (e = this.getPreviousNode(e, c))
                    : e ||
                      b === this.contain ||
