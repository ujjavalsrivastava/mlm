...
!(function (a, b, c, d) {
  ...
  function e(b, c, d) {
    ...
    (f.obj = b),
      (f.$obj = a(b)),
      a.data(f.obj, "cubeportfolio", f),
      (f.options = a.extend(
        {},
        a.fn.cubeportfolio.options,
        c,
        f.$obj.data("cbp-options")
      )),
      (f.isAnimating = !0),
      (f.defaultFilter = f.options.defaultFilter),
      (f.registeredEvents = []),
      (f.queue = []),
      (f.addedWrapp = !1),
      a.isFunction(d) && f.registerEvent("initFinish", d, !0);
    var g = f.$obj.children();
    f.$obj.addClass("cbp"),
      (0 === g.length || g.first().hasClass("cbp-item")) &&
        (f.wrapInner(f.obj, "cbp-wrapper"), (f.addedWrapp = !0)),
      (f.$ul = f.$obj.children().addClass("cbp-wrapper")),
      f.wrapInner(f.obj, "cbp-wrapper-outer"),
      (f.wrapper = f.$obj.children(".cbp-wrapper-outer")),
      (f.blocks = f.$ul.children(".cbp-item")),
      (f.blocksOn = f.blocks),
      f.wrapInner(f.blocks, "cbp-item-wrapper"),
      (f.plugins = a.map(e.plugins, function (a) {
        return a(f);
      })),
      f.triggerEvent("afterPlugins"),
      f.loadImages(f.$obj, f.display);
  }
  a.extend(e.prototype, {
    ...
    responsiveLayout: function () {
      ...
      b.blocks.each(function (b, d) {
        ...
        a.each(e.find("img").filter("[width][height]"), function (a, b) {
          ...
          c.push({ el: b, width: f, height: Math.round(f / g) });
        });
      }),
    ...
    getColumnsBreakpoints: function () {
      var b,
        ...
        e = c.width;
      return (
        a.each(c.options.mediaQueries, function (a, d) {
          return e >= d.width
            ? ((b = d.cols), c.triggerEvent("onMediaQueries", d.options), !1)
            : void 0;
        }),
        b === d &&
        ...
        a.each(b.freeSpaces, function (c, d) {
          b.blocksOn.each(function (c, e) {
            ...
            if (f.pack === !0 && b.intersectSpaces(d, f)) {
              ...
              -1 === g && (e.style.height = f.height - 1 + "px");
            }
          });
        });
      },
  ...
  (jQuery.fn.cubeportfolio.options = {
    ...
    singlePageCounter:
      '<div className="cbp-popup-singlePage-counter">{{current}} of {{total}}</div>',
  ...
  (function (a, b, c, d) {
    ...
    var f = a.fn.cubeportfolio.constructor;
    (f["private"].loadMoreScroll = new f["private"].publicEvents(
      "scroll.loadMore",
      100
    )),
      (e.prototype.createURL = function (a, b) {
                  ...
                  b.parent.$obj.cubeportfolio(
                    ...
                    function () {
                      e.removeClass("cbp-l-loadMore-loading"),
                        -1 === h && e.addClass("cbp-l-loadMore-stop");
                    }
                  );
                })
                .fail(function () {}));
                  ...
                  a
                    ...
                    .done(function (a) {
                      ...
                      var h,
                        i = b.indexOf(">", e) + 1,
                        j = b.indexOf(
                          "cbp-loadMore-block" + (g.numberOfClicks + 1)
                        );
                      (h =
                        -1 === j
                          ? b.lastIndexOf("</")
                          ...
                          function () {
                            -1 === j
                              ? (c.loadMore.addClass("cbp-l-loadMore-stop"),
                                f["private"].loadMoreScroll.destroyEvent(this),
                                c.parent.$obj.off("filterComplete.cbp"))
                              : ((g.isActive = !1),
                                d.trigger("scroll.loadMore"));
                          }
                        );
                    })
                    .fail(function () {
      ...
      g = {
          ...
          if (!i.isOpen) {
            ...
            a.each(d, function (b, c) {
              ...
              if (-1 === a.inArray(e, k)) {
                ...
                /youtube/i.test(e)
                  ...
                  ? ((g =
                    ...
                    (h = "isSelfHostedVideo"))
                  : /\.mp3$/i.test(e) && ((g = e), (h = "isSelfHostedAudio")),
                  i.dataArray.push({
                    src: g,
              ...
              1 === i.counterTotal
                ...
                : (i.nextButton.show(),
                  i.prevButton.show(),
                  (i.dataActionImg = 'data-action="next"')),
              i.wrap.appendTo(c.body),
              (i.scrollTop = a(b).scrollTop()),
              (i.originalStyle = a("html").attr("style")),
              a("html").css({
                overflow: "hidden",
              ...
              h.wrap.one(f["private"].transitionend, function () {
                a("html").css({
                  ...
                  h.options.singlePageStickyNavigation &&
                    ...
                    h.navigationWrap.width(h.wrap[0].clientWidth),
                    ("android" !== f["private"].browser &&
                      "ios" !== f["private"].browser) ||
                      ((h.navigationMobile = a("<div/>", {
                        class:
                          "cbp-popup-singlePage cbp-popup-singlePage-sticky",
                        id: h.wrap.attr("id"),
        ...
        updateSinglePageIsOpen: function () {
          ...
          c.wrap.addClass("cbp-popup-ready"),
            ...
            c.content.html(c.fromAJAX.html),
            c.fromAJAX.scripts && c.appendScriptsToWrap(c.fromAJAX.scripts),
            (c.fromAJAX = {}),
            c.cubeportfolio.$obj.trigger("updateSinglePageStart.cbp"),
            ...
            b
              ...
              : (c.slider = null),
            c.checkForSocialLinks(c.content),
            ("android" !== f["private"].browser &&
              "ios" !== f["private"].browser) ||
        ...
        updateSelfHostedVideo: function (a, b, c) {
          ...
          var f =
            '<div className="cbp-popup-lightbox-iframe"><video controls="controls" height="auto" style="width: 100%">';
          ...
          (f +=
            'Your browser does not support the video tag.</video><div className="cbp-popup-lightbox-bottom">' +
            (b
              ? '<div className="cbp-popup-lightbox-title">' + b + "</div>"
              : "") +
            c +
            "</div></div>"),
            e.content.html(f),
        ...
        updateSelfHostedAudio: function (a, b, c) {
          ...
          var e =
            '<div className="cbp-popup-lightbox-iframe"><div className="cbp-misc-video"><audio controls="controls" height="auto" style="width: 75%"><source src="' +
            a +
            '" type="audio/mpeg">Your browser does not support the audio tag.</audio></div><div className="cbp-popup-lightbox-bottom">' +
            (b
              ? '<div className="cbp-popup-lightbox-title">' + b + "</div>"
              : "") +
            c +
        ...
        updateVideoMarkup: function (a, b, c) {
          ...
          d.wrap.addClass("cbp-popup-lightbox-isIframe");
          var e =
            '<div className="cbp-popup-lightbox-iframe"><iframe src="' +
            a +
            '" frameborder="0" allowfullscreen scrolling="no"></iframe><div className="cbp-popup-lightbox-bottom">' +
            (b
              ? '<div className="cbp-popup-lightbox-title">' + b + "</div>"
              : "") +
            c +
        ...
        updateImagesMarkup: function (a, b, c) {
          ...
          var e =
            '<div className="cbp-popup-lightbox-figure"><img src="' +
            a +
        ...
        close: function (c, d) {
          function e() {
            i.content.html(""),
              i.wrap.detach(),
              i.cubeportfolio.$obj.removeClass(
                "cbp-popup-singlePageInline-open cbp-popup-singlePageInline-close"
              ),
              "promise" === c &&
                a.isFunction(d.callback) &&
                d.callback.call(i.cubeportfolio);
          }
          function g() {
            var d = a(b).scrollTop();
            i.resetWrap(),
              a(b).scrollTop(d),
              i.options.singlePageInlineInFocus && "promise" !== c
                ? a("html,body")
                    .animate({ scrollTop: i.scrollTop }, 350)
                    .promise()
                    .then(function () {
                      e();
                    })
          ...
          var i = this;
          (i.isOpen = !1),
            "singlePageInline" === i.type
              ? "open" === c
                ? (i.wrap.removeClass("cbp-popup-singlePageInline-ready"),
                  a(i.dataArray[i.current].element)
                    .closest(".cbp-item")
                    .removeClass("cbp-singlePageInline-active"),
                  i.openSinglePageInline(d.blocks, d.currentBlock, d.fromOpen))
                : ((i.height = 0),
                  i.revertResizeSinglePageInline(),
                  i.wrap.removeClass("cbp-popup-singlePageInline-ready"),
                  i.cubeportfolio.$obj.addClass(
              ...
              : "singlePage" === i.type
              ? (i.resetWrap(),
                i.wrap.removeClass("cbp-popup-ready cbp-popup-transitionend"),
                ("android" !== f["private"].browser &&
                  "ios" !== f["private"].browser) ||
                  (a("html").css({ position: "" }),
                  i.navigationWrap.appendTo(i.wrap),
                  i.navigationMobile.remove()),
                a(b).scrollTop(i.scrollTop),
                setTimeout(function () {
                  (i.stopScroll = !0),
              ...
              : ((h = !1),
                i.originalStyle
                  ? a("html").attr("style", i.originalStyle)
  ...
  (function (a, b, c, d) {
    ...
    function e(b) {
      ...
      d.length > 0 &&
        ...
        (c.parent.customPaginationclassName = c.options.paginationClass),
