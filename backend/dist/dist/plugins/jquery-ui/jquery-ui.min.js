  ...
  e.extend(n.prototype, {
    ...
    _attachments: function (t, i) {
      ...
      i.append && i.append.remove(),
        o &&
          ((i.append = e(
            "<span className='" + this._appendClass + "'>" + o + "</span>"
          )),
      ...
      for (
        ...
        for (k = "", this.maxRows = 4, T = 0; K[1] > T; T++) {
          if (
            ...
            if (((M += "<div className='ui-datepicker-group"), K[1] > 1))
              switch (T) {
                case 0:
    ...
    _generateMonthYearHeader: function (e, t, i, s, n, a, o, r) {
      var h,
        ...
        _ = "";
      if (a || !g)
        _ += "<span className='ui-datepicker-month'>" + o[t] + "</span>";
      else {
        for (
          h = s && s.getFullYear() === i,
            l = n && n.getFullYear() === i,
  ...
  (e.effects = { effect: {} }),
    ...
    (function () {
      ...
      e.each(
        ...
        (e.effects.animateclassName = function (n, a, o, r) {
          var h = e.speed(a, o, r);
    ...
    (e.effects.effect.transfer = function (t, i) {
      var s = e(this),
        ...
        d = s.offset(),
        c = e("<div className='ui-effects-transfer'></div>")
