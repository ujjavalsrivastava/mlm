...
!(function (t) {
      ...
      (p = e.opt("theme") ? "ui" : "fc"),
        i
          ? (g
              ? g.empty()
              : (g = this.el =
                  t("<div className='fc-toolbar " + n.extraClasses + "'/>")),
            g
              .append(o("left"))
              .append(o("right"))
              .append(o("center"))
                ...
                : ((r = o[i])
                  ...
                  h &&
                    ...
                    (m = c
                      ? ht(c)
                      : f && e.opt("theme")
                      ? "<span className='ui-icon ui-icon-" + f + "'></span>"
                      : g && !e.opt("theme")
                      ? "<span className='fc-icon fc-icon-" + g + "'></span>"
                      : ht(d)),
                    (y = [
                      "fc-" + i + "-button",
                      p + "-button",
  ...
  var fe = (Zt.EmitterMixin = {
    ...
    pe = bt.extend(ge, {
      ...
      render: function () {
        var e = this,
          n = this.options;
        (this.el = t('<div className="fc-popover"/>')
    ...
    De = (Zt.DayGrid = be.extend(Ee, {
      ...
      renderHelper: function (e, n) {
        ...
        return (
          ...
          this.rowEls.each(function (e, s) {
            var o,
              a = t(s),
              l = t('<div className="fc-helper-skeleton"><table/></div>');
            (o =
              n && n.row === e
                ? n.el.position().top
      ...
      renderFillRow: function (e, n, i) {
        ...
        return (
          (i = i || e.toLowerCase()),
          (r = t(
            '<div className="fc-' + i + '-skeleton"><table><tr/></table></div>'
          )),
          (s = r.find("tr")),
    ...
    fgSegHtml: function (t, e) {
      ...
      return (
        ...
        t.isStart &&
          ...
          (c = '<span className="fc-time">' + ht(n) + "</span>"),
        (i =
        ...
        '<a className="' +
          ...
          (this.isRTL ? i + " " + c : c + " " + i) +
          "</div>" +
          (a ? '<div className="fc-resizer fc-start-resizer" />' : "") +
          (l ? '<div className="fc-resizer fc-end-resizer" />' : "") +
          "</a>"
      );
    },
        ...
        if (
          ...
          for (l = 0; l < s.length; l++) {
            for (
              u = s[l],
                i(u.leftCol),
                h = t('<td className="fc-event-container"/>').append(u.el),
          ...
          for (
            ...
            if (h) {
              for (
                ...
                (v = t('<td className="fc-more-cell"/>').attr("rowspan", f)),
                  (u = c[p]),
  ...
  var Te = (Zt.TimeGrid = be.extend(Ee, {
    ...
    renderHtml: function () {
      return (
        ...
        '</table></div><div className="fc-slats"><table>' +
    ...
    renderNowIndicator: function (e) {
      ...
      for (n = 0; n < i.length; n++)
        s.push(
          t('<div className="fc-now-indicator fc-now-indicator-line"></div>')
            .css("top", r)
            .appendTo(this.colContainerEls.eq(i[n].col))[0]
        );
      i.length > 0 &&
        s.push(
          t('<div className="fc-now-indicator fc-now-indicator-arrow"></div>')
            .css("top", r)
      ...
      return (
        ...
        '<a className="' +
          ...
          (n
            ...
            : "") +
          (o.title
            ? '<div className="fc-title">' + ht(o.title) + "</div>"
            : "") +
          '</div><div className="fc-bg"/>' +
          (u ? '<div className="fc-resizer fc-end-resizer" />' : "") +
          "</a>"
      );
    },
  ...
  var Ce = (Zt.View = ue.extend({
    ...
    initThemingProps: function () {
      ...
      (this.widgetHeaderclassName = t + "-widget-header"),
        (this.widgetContentclassName = t + "-widget-content"),
        (this.highlightStateclassName = t + "-state-highlight");
    },
    renderBusinessHours: function () {},
    unrenderBusinessHours: function () {},
  ...
  var He = (Zt.Scroller = bt.extend({
    ...
    renderEl: function () {
      return (this.scrollEl = t('<div className="fc-scroller"></div>'));
    },
    clear: function () {
    ...
    Re.mixin({
      ...
      initialRender: function () {
        ...
        n.addClass("fc"),
          ...
          (this.contentEl = t("<div className='fc-view-container'/>").prependTo(
            n
          )),
          this.initToolbars(),
          this.renderHeader(),
        ...
        i && (this.freezeContentHeight(), this.clearView()),
          !this.view &&
            ...
            this.view.setElement(
              t("<div className='fc-view fc-" + e + "-view' />").appendTo(
                this.contentEl
              )
            ),
  ...
  var ze = (Zt.BasicView = Ce.extend({
      ...
      renderDates: function () {
        ...
        var e = this.scroller.el.addClass("fc-day-grid-container"),
          n = t('<div className="fc-day-grid" />').appendTo(e);
      ...
      renderSkeletonHtml: function () {
        return (
          '<table><thead className="fc-head"><tr><td className="fc-head-container ' +
          this.widgetHeaderClass +
          '"></td></tr></thead><tbody className="fc-body"><tr><td className="' +
  ...
  var Ge = (Zt.AgendaView = Ce.extend({
      ...
      renderDates: function () {
        ...
        var e = this.scroller.el.addClass("fc-time-grid-container"),
          n = t('<div className="fc-time-grid" />').appendTo(e);
        this.el.find(".fc-body > tr > td").append(e),
          this.timeGrid.setElement(n),
          this.timeGrid.renderDates(),
          (this.bottomRuleEl = t(
            '<hr className="fc-divider ' + this.widgetHeaderClass + '"/>'
    ...
    Ye = be.extend({
      ...
      renderSegList: function (e) {
        var n,
          ...
          o = t('<table className="fc-list-table"><tbody/></table>'),
          a = o.find("tbody");
