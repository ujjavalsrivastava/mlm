...
(function ($) {
  ...
  var btnShowMoreText = function () {
    ...
    showMoreBtn.on("click", function () {
      ...
      //    showMoreButton.html('Show Short <i className="icon-arrow-top"></i>');

      // } else {
      //     showMoreButton.html('Show More <i className="icon-arrow-top"></i>');
  ...
  var loadmoreParagraph = function () {
    if ($(".show-more-desc-item").length > 0) {
      $(".btn-show-more-decs").on("click", function () {
        $(this)
          .closest(".show-more-desc-item")
          .find(".showmore-paragraph")
          .slideDown();
