...
(function (factory) {
  ...
  var toolbar = renderer.create('<div className="note-toolbar card-header"/>');
  var editingArea = renderer.create('<div className="note-editing-area"/>');
  var codable = renderer.create('<textarea className="note-codable"/>');
  var editable = renderer.create(
    '<div className="note-editable card-block" contentEditable="true"/>'
  );
  ...
  var airEditor = renderer.create('<div className="note-editor"/>');
  ...
  var dropdownCheck = renderer.create(
    '<div className="dropdown-menu note-check">',
    function ($node, options) {
      var markup = $.isArray(options.items)
        ? options.items
            .map(function (item) {
              ...
              var content = options.template ? options.template(item) : item;
              return (
                '<a className="dropdown-item" href="#" data-value="' +
                value +
                '">' +
  ...
  var palette = renderer.create(
    ...
    function ($node, options) {
      ...
      for (var row = 0, rowSize = options.colors.length; row < rowSize; row++) {
        ...
        contents.push(
          '<div className="note-color-row">' + buttons.join("") + "</div>"
        );
      }
    ...
    function ($node, options) {
      ...
      $node.html(
        [
          ...
          options.footer
            ? '    <div className="modal-footer">' + options.footer + "</div>"
            : "",
          "  </div>",
          "</div>",
        ].join("")
  ...
  var checkbox = renderer.create(
    '<label className="custom-control custom-checkbox"></label>',
    function ($node, options) {
      if (options.id) {
  ...
  var ui = {
    ...
    button: function ($node, options) {
      return renderer.create(
        '<button type="button" className="note-btn btn btn-light btn-sm" tabindex="-1">',
        function ($node, options) {
  ...
  var Placeholder = function (context) {
    ...
    this.initialize = function () {
      this.$placeholder = $('<div className="note-placeholder">');
      this.$placeholder
        .on("click", function () {
  ...
  var LinkDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body =
        ...
        "</label>" +
        '<input className="note-link-text form-control ' +
        ...
        lang.link.url +
        "</label>" +
        '<input className="note-link-url form-control note-form-control ' +
        ...
        (!options.disableLinkTarget
          ...
          : "");
      var footer =
        '<button href="#" className="btn btn-primary note-btn note-btn-primary ' +
  ...
  var ImageDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body =
        ...
        "</label>" +
        '<input className="note-image-input form-control note-form-control note-input" ' +
  ...
  var VideoDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body =
        ...
        "</small></label>" +
        '<input className="note-video-url form-control  note-form-control note-input span12" ' +
        ' type="text" />' +
        "</div>";
      var footer =
        '<button href="#" className="btn btn-primary note-btn note-btn-primary ' +
    ...
    this.createShortCutList = function () {
      ...
      return Object.keys(keyMap)
        .map(function (key) {
          ...
          var $row = $('<div><div className="help-list-item"/></div>');
          $row
            .append(
  ...
  var HintPopover = function (context) {
    ...
    this.createItemTemplates = function (hintIdx, items) {
      ...
      return items.map(function (item, idx) {
        var $item = $('<div className="note-hint-item"/>');
    ...
    this.createGroup = function (idx, keyword) {
      var $group = $(
        '<div className="note-hint-group note-hint-group-' + idx + '"/>'
      );
