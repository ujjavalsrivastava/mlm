...
Object.defineProperty &&
      ...
      if (!H.initialized) {
        if (
          ...
          a(document, "createRange") &&
            ((b = document.createRange()), D(b, A) && F(b, z) && (c = !0)),
          (h = f(document)),
          !h || "body" != h.nodeName.toLowerCase())
        )
          return i("No body element found"), void 0;
        if (
          (h &&
            a(h, "createTextRange") &&
            ((b = h.createTextRange()), e(b) && (d = !0)),
          !c && !d)
        )
          return i("Neither Range nor TextRange are available"), void 0;
        (H.initialized = !0),
          (H.features = { implementsDomRange: c, implementsTextRange: d });
    ...
    var r,
      ...
      H = {
        ...
        config: {
          ...
          preferTextRange: !1,
          autoInitialize:
            typeof rangyAutoInitialize == y ? !0 : rangyAutoInitialize,
        },
      };
    return (
      (H.fail = i),
          ...
          : (a(document, "addEventListener") &&
            ...
            H.createCoreModule("DomUtil", [], function (a, b) {
              ...
              function s(a) {
                return (
                  a &&
                  J.isHostMethod(a, "setTimeout") &&
                  J.isHostObject(a, "document")
                );
              }
              function t(a, b, c) {
                var d;
              ...
              function y(a) {
                for (
                  var b, c = o(a).createDocumentFragment();
                  (b = a.firstChild);
              ...
              var D,
                ...
                I = "undefined",
                J = a.util;
              J.areHostMethods(document, [
                "createDocumentFragment",
                "createElement",
                "createTextNode",
              ]) || b.fail("document missing a Node creation method"),
                J.isHostMethod(document, "getElementsByTagName") ||
                ...
                typeof window.getComputedStyle != I
                  ...
                  : typeof document.documentElement.currentStyle != I
                    ...
                    : b.fail(
                        "No means of obtaining computed style properties found"
                      ),
                (z.prototype = {
                  _current: null,
                  hasNext: function () {
                ...
                (B.prototype = {
                  equals: function (a) {
                    return (
                      !!a && this.node === a.node && this.offset == a.offset
                    );
                  },
                  inspect: function () {
                    return (
                      "[DomPosition(" + x(this.node) + ":" + this.offset + ")]"
                    );
                  },
                  toString: function () {
                    return this.inspect();
            ...
            H.createCoreModule("DomRange", ["DomUtil"], function (a) {
              function b(a, b) {
                return (
                  3 != a.nodeType &&
                  (gb(a, b.startContainer) || gb(a, b.endContainer))
                );
              }
              function c(a) {
              ...
              function f(a, b, c) {
                ...
                return (
                  eb(b)
                    ? c == b.length
                      ? ab.insertAfter(a, b)
                      : b.parentNode.insertBefore(a, 0 == c ? b : jb(b, c))
              ...
              function h(a) {
                var b, d, e, f;
                for (
                  e = c(a.range).createDocumentFragment();
                  (d = a.next());
              ...
              function j(a) {
                for (var b; a.next(); )
                  a.isPartiallySelectedSubtree()
                    ? ((b = a.getSubtreeIterator()), j(b), b.detach())
                    : a.remove();
              }
              function k(a) {
                for (
                  var b, d, e = c(a.range).createDocumentFragment();
                  (b = a.next());
                ...
                return (
                  ...
                  i(new n(a, !1), function (b) {
                    ...
                    (!f || d.test(b.nodeType)) &&
                      (!g || c(b)) &&
                      ((h = a.startContainer),
                      (b == h && eb(h) && a.startOffset == h.length) ||
                        ((i = a.endContainer),
                        (b == i && eb(i) && 0 == a.endOffset) || e.push(b)));
                  }),
                  e
                );
              }
              function m(a) {
                ...
                return (
                  ...
                  b +
                  "(" +
                  ab.inspectNode(a.startContainer) +
                  ":" +
                  a.startOffset +
                  ", " +
                  ab.inspectNode(a.endContainer) +
                  ":" +
                  a.endOffset +
                  ")]"
                );
              ...
              function v(a) {
                return (
                  (ob && ab.isBrokenNode(a)) ||
                  (!mb(J, a.nodeType) && !N(a, !0))
                );
              }
              function w(a, b) {
                  ...
                  bb.extend(c.prototype, {
                    ...
                    canSurroundContents: function () {
                      ...
                      return (
                        ...
                        (a = new n(this, !0)),
                        (c =
                          (a._first && b(a._first, this)) ||
                          (a._last && b(a._last, this))),
                        a.detach(),
                        !c
                      );
                    },
                    ...
                    normalizeBoundaries: function () {
                      ...
                      y(this),
                        ...
                        eb(c)
                          ? c.length == d && e(c)
                          : (d > 0 &&
                              ((i = c.childNodes[d - 1]), i && eb(i) && e(i)),
                            (h = !this.collapsed)),
                        h
                          ? eb(a)
                            ? 0 == b && g(a)
                            : b < a.childNodes.length &&
                              ((j = a.childNodes[b]), j && eb(j) && g(j))
                          : ((a = c), (b = d)),
                        f(this, a, b, c, d);
                    },
              ...
              function F(a) {
                (a.collapsed =
                  ...
                  (a.commonAncestorContainer = a.collapsed
                    ? a.startContainer
                    : ab.getCommonAncestor(a.startContainer, a.endContainer));
              }
                  ...
                  return (
                    this.isSingleCharacterDataNode
                      ...
                      : ((a = new H(c(this.range))),
                        ...
                        (f = b),
                        (g = lb(b)),
                        gb(b, this.sc) && ((d = this.sc), (e = this.so)),
                        gb(b, this.ec) && ((f = this.ec), (g = this.eo)),
                        G(a, d, e, f, g)),
                ...
                (S = R
                  ? function (a) {
                      ...
                      return (
                        ...
                        1 == c.nodeType
                          ? (b = c)
                          : eb(c) && (b = ab.parentElement(c)),
                        (b =
                          null === b ||
                          ("HTML" == b.nodeName &&
                            ab.isHtmlNamespace(hb(b).documentElement) &&
                            ab.isHtmlNamespace(b))
                ...
                bb.extend(a.rangePrototype, {
                      ...
                      this.collapsed
                        ...
                        : this.startContainer === this.endContainer &&
                          ...
                          ? ((a = this.startContainer.cloneNode(!0)),
                            ...
                            b.appendChild(a),
                            b)
                          : ((d = new n(this, !0)), (a = h(d)), d.detach(), a)
                    );
                  },
                  canSurroundContents: function () {
                    var a, c;
                  ...
                  comparePoint: function (a, b) {
                    return (
                      ...
                      ib(a, b, this.startContainer, this.startOffset) < 0
                        ? -1
                        : ib(a, b, this.endContainer, this.endOffset) > 0
                          ? 1
                          : 0
                    );
                  },
                    ...
                    return (
                      ...
                      hb(a) !== c(this)
                        ...
                        : ((d = a.parentNode),
                          (e = fb(a)),
                          u(d, "NOT_FOUND_ERR"),
                          (f = ib(d, e, this.endContainer, this.endOffset)),
                          (g = ib(
                            d,
                            e + 1,
                            this.startContainer,
                  ...
                  containsNode: function (a, b) {
                    return b
                      ? this.intersectsNode(a, !1)
                      : this.compareNode(a) == _;
                  },
                  containsNodeContents: function (a) {
                    return (
                      this.comparePoint(a, 0) >= 0 &&
                      this.comparePoint(a, lb(a)) <= 0
                    );
                  },
                  containsRange: function (a) {
                    var b = this.interdiv(a);
                      ...
                      if (3 == c.nodeType)
                        (f = j + c.length),
                          !d &&
                            a.start >= j &&
                            a.start <= f &&
                            (this.setStart(c, a.start - j), (d = !0)),
                          d &&
                            a.end >= j &&
                            a.end <= f &&
                            (this.setEnd(c, a.end - j), (e = !0)),
                          (j = f);
                      else
                ...
                !(function () {
                  ...
                  (f.setStartBefore = g("setStartBefore", "setEndBefore")),
                    ...
                    (f.compareBoundaryPoints =
                      -1 == i.compareBoundaryPoints(i.START_TO_END, j) &&
                      1 == i.compareBoundaryPoints(i.END_TO_START, j)
                        ? function (a, b) {
                            return (
                              (b = b.nativeRange || b),
                              a == b.START_TO_END
                    ...
                    (a.createNativeRange = function (a) {
                      return (
                        (a = p(a, b, "createNativeRange")), a.createRange()
                      );
                    });
                })(),
                a.features.implementsTextRange &&
                  ...
                  (g = function (a, b, c, d, e) {
                    ...
                    if (
                      (y.collapse(c),
                      (f = y.parentElement()),
                      k.isOrIsAncestorOf(b, f) || (f = b),
                      !f.canHaveHTML)
                    )
                      return (
                        (g = new m(f.parentNode, k.getNodeIndex(f))),
                        {
                          boundaryPosition: g,
                          nodeInfo: {
                            nodeIndex: g.offset,
                    ...
                    for (
                      h = k.getDocument(f).createElement("span"),
                        h.parentNode && h.parentNode.removeChild(h),
                        j = c ? "StartToStart" : "StartToEnd",
                        r = e && e.containerElement == f ? e.nodeIndex : 0,
                        s = f.childNodes.length,
                        t = s,
                        u = t;
                      ;
                      ...
                      if (
                        (u == s
                          ? f.appendChild(h)
                          : f.insertBefore(h, f.childNodes[u]),
                        y.moveToElementText(h),
                        (i = y.compareEndPoints(j, a)),
                        0 == i || r == t)
                      )
                        break;
                      if (-1 == i) {
                    ...
                    if (((p = h.nextSibling), -1 == i && p && q(p))) {
                      if (
                        (y.setEndPoint(c ? "EndToStart" : "EndToEnd", a),
                        /[\r\n]/.test(p.data))
                      )
                        for (
                          w = y.duplicate(),
                            x = w.text.replace(/\r\n/g, "\r").length,
                            v = w.moveStart("character", x);
                          -1 == (i = w.compareEndPoints("StartToEnd", w));
                      ...
                      (l = (d || !c) && h.previousSibling),
                        (n = (d || c) && h.nextSibling),
                        (o =
                          n && q(n)
                            ? new m(n, 0)
                            : l && q(l)
                              ? new m(l, l.data.length)
                              : new m(f, k.getNodeIndex(h)));
                    return (
                      h.parentNode.removeChild(h),
                      {
                        boundaryPosition: o,
                        nodeInfo: { nodeIndex: u, containerElement: f },
                      }
                    );
                  }),
                  (h = function (a, b) {
                  ...
                  (d.prototype.refresh = function () {
                    var a,
                      ...
                      d = e(this.textRange);
                    f(this.textRange)
                      ? (b = a = g(this.textRange, d, !0, !0).boundaryPosition)
                      : ((c = g(this.textRange, d, !0, !1)),
                  ...
                  (i = function (a) {
                    var b, c, d;
                    return a.collapsed
                      ? h(new m(a.startContainer, a.startOffset), !0)
                      : ((b = h(new m(a.startContainer, a.startOffset), !0)),
                        (c = h(new m(a.endContainer, a.endOffset), !1)),
                        (d = o(n.getRangeDocument(a)).createTextRange()),
              ...
              function (a, b) {
                    ...
                    b instanceof D
                      ...
                      : b instanceof E
                        ...
                        : J.implementsDomRange &&
                          b instanceof A.getWindow(b.startContainer).Range &&
                          (c = b),
                    c
                  );
                }
                ...
                function p(b) {
                  ...
                  if (((b._ranges.length = 0), "None" == b.docSelection.type))
                    ...
                    for (
                      b.rangeCount = c.length, e = L(c.item(0)), f = 0;
                      f < b.rangeCount;
                      ++f
                    )
                      (d = a.createRange(e)),
                        ...
                        b._ranges.push(d);
                    (b.isCollapsed =
                      1 == b.rangeCount && b._ranges[0].collapsed),
                ...
                function w(b) {
                  return function (c, d) {
                    ...
                    this.rangeCount
                      ? ((e = this.getRangeAt(0)),
                        e["set" + (b ? "Start" : "End")](c, d))
                      : ((e = a.createRange(this.win.document)),
                ...
                if (
                  ...
                  Q
                    ? ((H = f),
                      (a.isSelectionValid = function (a) {
                        ...
                        return (
                          "None" != c.type ||
                          L(c.createRange().parentElement()) == b
                        );
                      }))
                    : O
                      ? ((H = e),
                  ...
                  B.areHostMethods(R, [
                    ...
                    !(function () {
                      ...
                      if (n) {
                        for (
                          b = n.rangeCount, c = b > 1, d = [], e = g(n), f = 0;
                          b > f;
                          ++f
                        )
                          d[f] = n.getRangeAt(f);
                        for (
                          h = M(document),
                            ...
                            c ||
                              ((l =
                                window.navigator.appVersion.match(
                                  /Chrome\/(.*?) /
                                )),
                              l && parseInt(l[1]) >= 36
                                ? (X = !1)
                  ...
                  ($ = !1),
                  T &&
                    C(T, "createControlRange") &&
                    ((_ = T.createControlRange()),
                    B.areHostProperties(_, ["item", "add"]) && ($ = !0)),
                  (J.implementsControlRange = $),
                  (I = U
                    ? function (a) {
                        return (
                          a.anchorNode === a.focusNode &&
                          a.anchorOffset === a.focusOffset
                        );
                      }
                    : function (a) {
                        return a.rangeCount
                          ? a.getRangeAt(a.rangeCount - 1).collapsed
                          : !1;
                      }),
                  C(R, "getRangeAt")
                    ? (ab = function (a, b) {
                  ...
                  !Q &&
                    U &&
                    B.areHostMethods(R, ["removeAllRanges", "addRange"]))
                )
                  (db.removeAllRanges = function () {
                    ...
                    (db.addRange = W
                      ? function (b, d) {
                          var e, f;
                          $ && P && this.docSelection.type == K
                            ? q(this, b)
                            : c(d) && V
                              ? eb(this, b)
                              : (X
                                  ? (e = this.rangeCount)
                                  : (this.removeAllRanges(), (e = 0)),
                        ...
                        "None" != this.docSelection.type &&
                          (this.anchorNode
                            ...
                            : this.docSelection.type == K &&
                              ((b = this.docSelection.createRange()),
                              b.length && (a = L(b.item(0)))),
                          a &&
                            ((c = M(a).createTextRange()),
                            c.select(),
                            this.docSelection.empty()));
                    } catch (d) {}
                    j(this);
                ...
                if (
                  ...
                  fb = function (b) {
                    ...
                    a.isSelectionValid(b.win)
                      ...
                      : ((c = M(b.win.document).createTextRange()),
                        c.collapse(!0)),
                  ...
                  fb = function (b) {
                    if ($ && P && b.docSelection.type == K) p(b);
                      ...
                      ((b._ranges.length = b.rangeCount =
                        b.nativeSelection.rangeCount),
                      b.rangeCount)
                    ) {
                  ...
                  if (
                    !U ||
                    typeof R.isCollapsed != y ||
                    typeof S.collapsed != y ||
                    !J.implementsDomRange
                  )
                    return (
                      b.fail(
                ...
                (db.refresh = function (a) {
                  ...
                  (db.deleteFromDocument = function () {
                    ...
                    if ($ && P && this.docSelection.type == K) {
                      ...
                      this.rangeCount &&
                      ((c = this.getAllRanges()), c.length)
                    ) {
                      for (
                        this.removeAllRanges(), d = 0, e = c.length;
                        e > d;
                        ++d
                      )
                        c[d].deleteContents();
                  ...
                  (db.getBookmark = function (a) {
                    return {
                      ...
                      rangeBookmarks: this.callMethodOnEachRange(
                        "getBookmark",
                        [a]
                      ),
                    };
                  ...
                  (db.moveToBookmark = function (b) {
                    ...
                    for (c = 0; (d = b.rangeBookmarks[c++]); )
                      (e = a.createRange(this.win)),
                        ...
                        f.push(e);
                    b.backward
                      ? this.setSingleRange(f[0], "backward")
                      : this.setRanges(f);
                  }),
                  (db.toHtml = function () {
                    var a = [];
                  ...
                  J.implementsTextRange &&
                    (db.getNativeTextRange = function () {
                      ...
                      if (this.rangeCount > 0)
                        return a.WrappedTextRange.rangeToTextRange(
                          this.getRangeAt(0)
                        );
                      throw b.createError(
  ...
  (function (a, b) {
    ...
    a.createModule("SaveRestore", ["WrappedRange"], function (a, b) {
      ...
      function e(a, d, e, f) {
        var g = c(e, a);
        g
          ? (d[f ? "setStartBefore" : "setEndBefore"](g),
            ...
            ? ((h = c(d.markerId, j)),
              h
                ? ((h.style.display = "inline"),
                  ...
                  i && 3 == i.nodeType
                    ? (h.parentNode.removeChild(h),
                      g.collapseToPoint(i, i.length))
                    : (g.collapseBefore(h), h.parentNode.removeChild(h)))
                : b.warn(
                    "Marker element has been removed. Cannot restore selection."
                  ))
            : (e(j, g, d.startMarkerId, !0), e(j, g, d.endMarkerId, !1)),
      ...
      function i(b, d) {
        ...
        for (i = j - 1; i >= 0; --i)
          (e = b[i]),
            ...
            e.collapsed
              ? e.collapseAfter(c(k[i].markerId, h))
              : (e.setEndBefore(c(k[i].endMarkerId, h)),
                e.setStartAfter(c(k[i].startMarkerId, h)));
        return k;
      }
      function j(c) {
        var d, e, f, g;
        return a.isSelectionValid(c)
          ? ((d = a.getSelection(c)),
            (e = d.getAllRanges()),
            (f = 1 == e.length && d.isBackward()),
            (g = i(e, f)),
            f ? d.setSingleRange(e[0], "backward") : d.setRanges(e),
            { win: c, rangeInfos: g, restored: !1 })
          : (b.warn(
      ...
      function n(a) {
        ...
        for (b = 0, c = e.length; c > b; ++b)
          (d = e[b]),
            d.collapsed
              ? m(a.doc, d.markerId)
              : (m(a.doc, d.startMarkerId), m(a.doc, d.endMarkerId));
      }
      var o = a.dom,
        p = "﻿";
      a.util.extend(a, {
  ...
  (wysihtml5.browser = (function () {
    function a(a) {
      return +((/ipad|iphone|ipod/.test(a) &&
        a.match(/ os (\d+).+? like mac os x/)) || [void 0, 0])[1];
    }
    function b(a) {
      ...
      return (
        "Microsoft Internet Explorer" == navigator.appName
          ...
          : "Netscape" == navigator.appName &&
            (c = RegExp("Trident/.*rv:([0-9]{1,}[.0-9]{0,})")),
  ...
  (wysihtml5.lang.object = function (a) {
    return {
      ...
      clone: function (b) {
        ...
        for (c in a)
          a.hasOwnProperty(c) &&
            (d[c] = b ? wysihtml5.lang.object(a[c]).clone(b) : a[c]);
        return d;
      },
      isArray: function () {
        return "[object Array]" === Object.prototype.toString.call(a);
  ...
  (function (a) {
    ...
    function e(b) {
      var e = b.parentNode,
        ...
        g = d(e.ownerDocument);
      for (
        g.innerHTML = "<span></span>" + c(f), g.removeChild(g.firstChild);
        g.firstChild;
    ...
    function f(b, c) {
      for (var d; b.parentNode; ) {
        if (
          ((b = b.parentNode),
          (d = b.nodeName),
          b.className && a.lang.array(b.className.split(" ")).contains(c))
        )
          return !0;
    ...
    function g(b, c) {
      if (
        !(
          h.contains(b.nodeName) ||
          (b.className && a.lang.array(b.className.split(" ")).contains(c))
        )
      ) {
        if (b.nodeType === a.TEXT_NODE && b.data.match(i)) return e(b), void 0;
        for (
          var d = a.lang.array(b.childNodes).get(), f = d.length, j = 0;
          f > j;
          j++
        )
          g(d[j], c);
  ...
  (function (a) {
    var b = a.dom;
    (b.addclassName = function (a, c) {
      var d = a.classList;
      return d
        ? d.add(c)
        : (b.hasClass(a, c) || (a.className += " " + c), void 0);
    }),
  ...
  (wysihtml5.dom.contains = (function () {
    ...
    return a.contains
      ? function (a, b) {
          return (
            b.nodeType !== wysihtml5.ELEMENT_NODE && (b = b.parentNode),
            a !== b && a.contains(b)
          );
        }
  ...
  (wysihtml5.dom.convertToList = (function () {
    ...
    function c(c, d, e) {
      ...
      for (
        f = wysihtml5.lang.array(c.childNodes).get(), g = f.length, n = 0;
        g > n;
        n++
      )
        (m = m || a(o, p)),
          ...
          (l = "BR" === h.nodeName),
          !k || (e && wysihtml5.dom.hasClass(h, e))
            ? l
  ...
  (function (a) {
    var b = [
      ...
      c = function (b) {
        return d(b)
          ? parseInt(a.getStyle("width").from(b), 10) < b.offsetWidth
          : !1;
      },
      d = function (c) {
  ...
  (function (a) {
    a.dom.delegate = function (b, c, d, e) {
      return a.dom.observe(b, d, function (d) {
        for (
          var f = d.target, g = a.lang.array(b.querySelectorAll(c));
          f && f !== b;
    ...
    a.dom.domNode = function (b) {
      ...
      return {
        prev: function (e) {
          ...
          return f
            ? !a.lang.array(g).contains(f.nodeType) ||
              (e && e.ignoreBlankTexts && d(f))
              ? a.dom.domNode(f).prev(e)
              : f
            : null;
        },
        next: function (e) {
    ...
    return function (c, d) {
      ...
      return (
        "object" == typeof c && c.nodeType
          ...
          : wysihtml5.browser.supportsHTML5Tags(d)
  ...
  (wysihtml5.dom.getParentElement = (function () {
    function a(a, b) {
      return b && b.length
        ? "string" == typeof b
          ? a === b
          : wysihtml5.lang.array(b).contains(a)
        : !0;
    }
    function b(a) {
    ...
    return function (e, f, g, h) {
      ...
      for (
        g = g || 50;
        g-- && e && "BODY" !== e.nodeName && (!h || e !== h);

      ) {
        if (
          b(e) &&
          a(e.nodeName, f.nodeName) &&
          (!i || d(e, f.cssStyle, f.styleRegExp)) &&
          (!j || c(e, f.className, f.classRegExp))
        )
          return e;
        e = e.parentNode;
      }
      ...
      return {
        from: function (d) {
          ...
          if (d.nodeType === wysihtml5.ELEMENT_NODE) {
            ...
            return (
              (j = e.defaultView || e.parentWindow),
              (k =
                ("height" === c || "width" === c) && "TEXTAREA" === d.nodeName),
              j.getComputedStyle
                ? (k && ((l = g.overflow), (g.overflow = "hidden")),
                  (m = j.getComputedStyle(d, null).getPropertyValue(c)),
                  k && (g.overflow = l || ""),
                  m)
                : void 0
            );
  ...
  (wysihtml5.dom.getTextNodes = function (a, b) {
    ...
    for (a = a.firstChild; a; a = a.nextSibling)
      3 == a.nodeType
        ...
        : (c = c.concat(wysihtml5.dom.getTextNodes(a, b)));
    return c;
  }),
      ...
      (a = a.join("\n")),
      {
        into: function (b) {
          ...
          return (
            ...
            c
              ? (c.parentNode.insertBefore(e, c), void 0)
              : ((d = b.querySelector("head")), d && d.appendChild(e), void 0)
          );
        },
      }
    );
  ...
  (function (a) {
    a.dom.lineBreaks = function (b) {
      ...
      function d(b) {
        return c(b)
          ? !0
          : "block" === a.dom.getStyle("display").from(b)
            ? !0
            : !1;
      }
      return {
  ...
  (wysihtml5.dom.parse = function (a, b) {
    function c(a, b) {
      ...
      for (
        wysihtml5.lang.object(t).merge(s).merge(b.rules).get(),
          c = b.context || a.ownerDocument || document,
          f = c.createDocumentFragment(),
          g = "string" == typeof a,
          h = !1,
          b.clearInternals === !0 && (h = !0),
          i = g ? wysihtml5.dom.getAsDom(a, c) : a,
          t.selectors && e(i, t.selectors);
        i.firstChild;
      ...
      if (b.unjoinNbsps)
        for (l = wysihtml5.dom.getTextNodes(f), m = l.length; m--; )
          l[m].nodeValue = l[m].nodeValue.replace(
            /([\S\u00A0])\u00A0/gi,
            "$1 "
          );
      return (
    ...
    function d(a, b, c, e) {
      ...
      if (((g = l && l(a, c)), !g)) {
        if (g === !1) {
          for (f = a.ownerDocument.createDocumentFragment(), m = k; m--; )
            j[m] &&
              ((h = d(j[m], b, c, e)),
              h && (j[m] === h && m--, f.insertBefore(h, f.firstChild)));
          return (
            "block" === wysihtml5.dom.getStyle("display").from(a) &&
            ...
            wysihtml5.lang
              ...
              ((a.nextSibling &&
                ...
                /^\s/.test(a.nextSibling.nodeValue)) ||
      ...
      for (m = 0; k > m; m++)
        j[m] &&
          ((h = d(j[m], b, c, e)), h && (j[m] === h && m--, g.appendChild(h)));
      if (
        b &&
        ...
        (!g.childNodes.length ||
          (/^\s*$/gi.test(g.innerHTML) &&
            (c ||
              ("_wysihtml5-temp-placeholder" !== a.className &&
                "rangySelectionBoundary" !== a.className))) ||
          !g.attributes.length)
      ) {
    ...
    function e(a, b) {
      ...
      for (c in b)
        if (b.hasOwnProperty(c))
          for (
            wysihtml5.lang.object(b[c]).isFunction()
              ? (d = b[c])
              : "string" == typeof b[c] && z[b[c]] && (d = z[b[c]]),
    ...
    function h(a, b) {
      ...
      if (k && b.classes)
        for (
          k = k.replace(/^\s+/g, "").replace(/\s+$/g, "").split(r),
            c = k.length,
            i = 0;
          c > i;
          i++
              ...
              if (
                ...
                g[0].replace(/\s/g, "").toLowerCase() === d &&
                  (b.styles[d] === !0 ||
                    ...
                    wysihtml5.lang
                      .array(b.styles[d])
                      .contains(g[1].replace(/\s/g, "").toLowerCase())))
              )
                return !0;
      }
      if (b.attrs)
        for (e in b.attrs)
          if (
            ...
            ((f = wysihtml5.dom.getAttribute(a, e)),
            "string" == typeof f && f.search(b.attrs[e]) > -1)
          )
            return !0;
      return !1;
    }
        ...
        for (d in c.keep_styles)
          if (c.keep_styles.hasOwnProperty(d)) {
            if (
              ((e =
                "float" === d
                  ? a.style.styleFloat || a.style.cssFloat
                  : a.style[d]),
    ...
    function m(a, b, c, d) {
      var e,
        ...
        y = [];
      if (
        (o && (j = wysihtml5.lang.object(o).clone()),
        (j = wysihtml5.lang.object(j).merge(l(a, c.check_attributes)).get()),
        k && s.push(k),
        m)
      )
        for (h in m)
          (i = x[m[h]]),
            i &&
              ((g = i(wysihtml5.dom.getAttribute(a, h))),
              "string" == typeof g && s.push(g));
      if (n)
        for (h in n)
          (i = w[n[h]]),
            i &&
              ((newStyle = i(wysihtml5.dom.getAttribute(a, h))),
              "string" == typeof newStyle && u.push(newStyle));
      if ("string" == typeof p && "any" === p && a.getAttribute("class"))
        ...
        for (
          d ||
            ((p["_wysihtml5-temp-placeholder"] = 1),
      ...
      j.src &&
        (void 0 !== j.width && b.setAttribute("width", j.width),
        void 0 !== j.height && b.setAttribute("height", j.height));
    }
    function n(a) {
      var b,
        c = a.nextSibling;
      return c && c.nodeType === wysihtml5.TEXT_NODE
        ? ((c.data = a.data.replace(u, "") + c.data.replace(u, "")), void 0)
        : ((b = a.data.replace(u, "")), a.ownerDocument.createTextNode(b));
    }
    function o(a) {
    ...
    var p = { 1: f, 3: n, 8: o },
      ...
      y = {
        has_visible_contet: (function () {
          ...
          return function (c) {
            if (
              ((a = (c.innerText || c.textContent).replace(/\s/g, "")),
              a && a.length > 0)
            )
              return !0;
  ...
  (wysihtml5.dom.removeEmptyTextNodes = function (a) {
    for (
      var b, c = wysihtml5.lang.array(a.childNodes).get(), d = c.length, e = 0;
      d > e;
      e++
    )
      (b = c[e]),
        b.nodeType === wysihtml5.TEXT_NODE &&
          "" === b.data &&
          b.parentNode.removeChild(b);
  }),
    ...
    function e(a, e) {
      if (a.nodeName.match(/^(MENU|UL|OL)$/)) {
        ...
        if (e)
          for (
            !n || b(n) || c(n) || d(m);
            (k = a.firstElementChild || a.firstChild);
    ...
    a.dom.Sandbox = Base.extend({
      ...
      _createIframe: function () {
        ...
        return (
          ...
          a.dom
            ...
            .on(d),
          a.browser.throwsMixedContentWarningWhenIframeSrcIsEmpty() &&
      ...
      _getHtml: function (b) {
        ...
        return (
          ...
          a.lang
            .string(
              '<!DOCTYPE html><html><head><meta charset="#{charset}">#{stylesheets}</head><body></body></html>'
            )
            .interpolate(b)
        );
      },
  ...
  (wysihtml5.dom.setStyles = function (a) {
    return {
      on: function (b) {
        ...
        for (c in a)
          "float" === c
            ? ((d.cssFloat = a[c]), (d.styleFloat = a[c]))
            : (d[c] = a[c]);
      },
    };
  }),
  (function (a) {
    a.simulatePlaceholder = function (b, c, d) {
      var e = "placeholder",
            ...
            b &&
              setTimeout(function () {
                ...
                (a.focusNode && a.anchorNode) ||
                  c.selection.selectNode(c.element.firstChild || c.element);
              }, 0)),
            (c.placeholderSet = !1),
        ...
        g = function () {
          c.isEmpty() &&
            ((c.placeholderSet = !0), c.setValue(d), a.addClass(c.element, e));
        };
      b
        .on("set_placeholder", g)
        .on("unset_placeholder", f)
        .on("focus:composer", f)
        .on("paste:composer", f)
        .on("blur:composer", g),
        g();
  ...
  (wysihtml5.dom.getAttribute = function (a, b) {
    ...
    return (
      (b = b.toLowerCase()),
      (c = a.nodeName),
      "IMG" == c && "src" == b && wysihtml5.dom.isLoadedImage(a) === !0
        ? a.src
        : f && "outerHTML" in a
          ? ((d = a.outerHTML.toLowerCase()),
            (e = -1 != d.indexOf(" " + b + "=")),
            e ? a.getAttribute(b) : null)
          : a.getAttribute(b)
    );
  }),
    ...
    for (b in a.attributes)
      ((a.attributes.hasOwnProperty && a.attributes.hasOwnProperty(b)) ||
        (!a.attributes.hasOwnProperty &&
          Object.prototype.hasOwnProperty.call(a.attributes, b))) &&
        a.attributes[b].specified &&
        ("IMG" == d &&
        "src" == a.attributes[b].name.toLowerCase() &&
        wysihtml5.dom.isLoadedImage(a) === !0
          ? (e.src = a.src)
          : wysihtml5.lang
                .array(["rowspan", "colspan"])
                .contains(a.attributes[b].name.toLowerCase()) && c
            ? 1 !== a.attributes[b].value &&
  ...
  (function (a) {
    ...
    var g = a.dom,
      ...
      i = function (a, b) {
        a
          ? ((this.cell = a),
            (this.table = g.getParentElement(a, { nodeName: ["TABLE"] })))
          : b &&
            ((this.table = b),
    ...
    (i.prototype = {
        ...
        for (a = 0; a < l.length; a++)
          for (
            ...
            (i = g.getAttribute(e, "colspan")),
              ...
              i || j
                ? (this.addSpannedCellToMap(e, k, a, f, i, j),
                  (f += i ? parseInt(i, 10) : 1))
                : ((k[a][f] = new h(e)), f++);
          }
        return (this.map = k), k;
      ...
      getElementAtIndex: function (a) {
        return (
          this.setTableMap(),
          this.map[a.row] && this.map[a.row][a.col] && this.map[a.row][a.col].el
            ? this.map[a.row][a.col].el
            : null
        );
      },
      getMapElsTo: function (a) {
        ...
        if (
          ...
          (this.idx_start.row > this.idx_end.row ||
            ...
            (this.idx_end = b)),
          this.idx_start.col > this.idx_end.col &&
            ((c = this.idx_start.col),
            (this.idx_start.col = this.idx_end.col),
            (this.idx_end.col = c)),
          null != this.idx_start && null != this.idx_end)
        )
      ...
      getLastNewCellOnRow: function (a, b) {
        ...
        for (e = 0, f = g.length; f > e; e++)
          if (
            ((c = g[e]),
            (d = this.getMapIndex(c)),
            d === !1 || (void 0 !== b && d.row != b))
          )
            return c;
        return null;
      },
      ...
      splitRowToCells: function (a) {
        var b, c, d;
        a.isColspan &&
          ((b = parseInt(g.getAttribute(a.el, "colspan") || 1, 10)),
          (c = a.el.tagName.toLowerCase()),
          b > 1 && ((d = this.createCells(c, b - 1)), e(a.el, d)),
      ...
      getRealRowEl: function (a, b) {
        ...
        for (b = b || this.idx, c = 0, d = this.map[b.row].length; d > c; c++)
          if (
            ((f = this.map[b.row][c]),
            f.isReal &&
              ((e = g.getParentElement(f.el, { nodeName: ["TR"] })), e))
          )
            return e;
        return (
          null === e &&
            a &&
            (e =
              g.getParentElement(this.map[b.row][b.col].el, {
                nodeName: ["TR"],
              }) || null),
          e
        );
      ...
      injectRowAt: function (a, b, c, d, f) {
        ...
        j
          ? ((h = this.correctColIndexForUnreals(b, a)),
            h >= 0
              ? e(this.getRowCells(j)[h], k)
              : j.insertBefore(k, j.firstChild))
          : ((i = this.table.ownerDocument.createElement("tr")),
            i.appendChild(k),
            e(g.getParentElement(f.el, { nodeName: ["TR"] }), i));
      },
      canMerge: function (a) {
        var b, c, d, e, f, g;
        for (
          ...
          for (c = 0, e = this.map.length; e > c; c++) {
            for (a = this.map[c], i = !0, f = 0, h = a.length; h > f; f++)
              if (
                ((b = a[f]),
                !(
                  g.getAttribute(b.el, "rowspan") &&
                  parseInt(g.getAttribute(b.el, "rowspan"), 10) > 1 &&
                  b.firstRow !== !0
                ))
              ) {
                i = !1;
          ...
          for (j = this.getTableRows(), c = 0, e = j.length; e > c; c++)
            (a = j[c]),
              0 == a.childNodes.length &&
                /^\s*$/.test(a.textContent || a.innerText) &&
                d(a);
        }
      },
          ...
          for (b = 0; d > b; b++)
            for (c = 0; f > c; c++)
              this.map[b] &&
                !this.map[b][c] &&
                c > 0 &&
                ((this.map[b][c] = new h(this.createCells("td", 1))),
                (g = this.map[b][c - 1]),
                g &&
                  g.el &&
                  g.el.parent &&
                  e(this.map[b][c - 1].el, this.map[b][c].el));
        }
      },
      rectify: function () {
        return this.removeEmptyTable()
          ? !1
          : (this.removeSurplusLines(), this.fillMissingCells(), !0);
      },
      unmerge: function () {
        var a, b, c, d, e, f;
        if (
          ...
          if (
            ((a = this.map[this.idx.row][this.idx.col]),
            (b = g.getAttribute(a.el, "colspan")
              ? parseInt(g.getAttribute(a.el, "colspan"), 10)
              : 1),
            (c = a.el.tagName.toLowerCase()),
            a.isRowspan)
          ) {
      ...
      merge: function (a) {
        ...
        if (this.rectify())
          if (this.canMerge(a)) {
            for (
              b = this.idx_end.row - this.idx_start.row + 1,
                c = this.idx_end.col - this.idx_start.col + 1,
              ...
              for (g = this.idx_start.col, h = this.idx_end.col; h >= g; g++)
                e == this.idx_start.row && g == this.idx_start.col
                  ? (b > 1 && this.map[e][g].el.setAttribute("rowspan", b),
                    c > 1 && this.map[e][g].el.setAttribute("colspan", c))
                  : (/^\s*<br\/?>\s*$/.test(
                      this.map[e][g].el.innerHTML.toLowerCase()
                    ) ||
                      (this.map[this.idx_start.row][
                        this.idx_start.col
                      ].el.innerHTML += " " + this.map[e][g].el.innerHTML),
                    d(this.map[e][g].el));
            this.rectify();
      ...
      collapseCellToNextRow: function (a) {
        var b,
          ...
          i = { row: h, col: f.col };
        h < this.map.length &&
          ((b = this.getRealRowEl(!1, i)),
          null !== b &&
            ((c = this.correctColIndexForUnreals(i.col, i.row)),
            c >= 0
              ? e(this.getRowCells(b)[c], a.el)
              : ((d = this.getLastNewCellOnRow(b, h)),
                null !== d ? e(d, a.el) : b.insertBefore(a.el, b.firstChild)),
            parseInt(g.getAttribute(a.el, "rowspan"), 10) > 2
              ? a.el.setAttribute(
                  "rowspan",
                  parseInt(g.getAttribute(a.el, "rowspan"), 10) - 1
                )
              : a.el.removeAttribute("rowspan")));
      },
      ...
      getColumnElementsByCell: function () {
        ...
        if (
          ...
          for (a = 0, b = this.map.length; b > a; a++)
            this.map[a][this.idx.col] &&
              this.map[a][this.idx.col].isReal &&
              c.push(this.map[a][this.idx.col].el);
        return c;
      },
      removeRow: function () {
        var a,
        ...
        if (e) {
          if (
            ...
            for (a = this.map[this.idx.row], b = 0, c = a.length; c > b; b++)
              a[b].modified ||
                (this.setCellAsModified(a[b]), this.removeRowCell(a[b]));
          d(e);
        }
      },
      removeColCell: function (a) {
        a.isColspan
          ? parseInt(g.getAttribute(a.el, "colspan"), 10) > 2
            ? a.el.setAttribute(
                "colspan",
                parseInt(g.getAttribute(a.el, "colspan"), 10) - 1
              )
            : a.el.removeAttribute("colspan")
          : a.isReal && d(a.el);
      },
        ...
        if (
          ...
          for (var a = 0, b = this.map.length; b > a; a++)
            this.map[a][this.idx.col].modified ||
              (this.setCellAsModified(this.map[a][this.idx.col]),
      ...
      addRow: function (a) {
        ...
        if (
          ...
          (this.idx = this.getMapIndex(this.cell)),
          "below" == a &&
            g.getAttribute(this.cell, "rowspan") &&
            (this.idx.row =
              this.idx.row +
              parseInt(g.getAttribute(this.cell, "rowspan"), 10) -
              1),
          this.idx !== !1)
        ) {
          for (
            b = this.map[this.idx.row],
            ...
            b[d].modified ||
              (this.setCellAsModified(b[d]), this.addRowCell(b[d], c, a));
          switch (a) {
            case "below":
      ...
      add: function (a) {
        this.rectify() &&
          (("below" == a || "above" == a) && this.addRow(a),
          ("before" == a || "after" == a) && this.addColumn(a));
      },
      ...
      addColumn: function (a) {
        ...
        if (
          ...
          (this.idx = this.getMapIndex(this.cell)),
          "after" == a &&
            g.getAttribute(this.cell, "colspan") &&
            (this.idx.col =
              this.idx.col +
              parseInt(g.getAttribute(this.cell, "colspan"), 10) -
              1),
          this.idx !== !1)
        )
          for (d = 0, e = this.map.length; e > d; d++)
            (b = this.map[d]),
              b[this.idx.col] &&
                ((c = b[this.idx.col]),
                c.modified ||
                  (this.setCellAsModified(c), this.addColCell(c, d, a)));
      },
      handleCellAddWithRowspan: function (a, b, c) {
        ...
        for (j = 0; k > j; j++)
          if (
            ((d = this.correctColIndexForUnreals(this.idx.col, b + j)),
            (l = f(l, "tr")),
            l)
          )
            if (d > 0)
              switch (c) {
                case "before":
                  (h = this.getRowCells(l)),
                    d > 0 &&
                    this.map[b + j][this.idx.col].el != h[d] &&
                    d == h.length - 1
                      ? e(h[d], this.createCells(m, 1))
                      : h[d].parentNode.insertBefore(
                          this.createCells(m, 1),
                          h[d]
                        );
                  break;
                case "after":
    ...
    return a.compareDocumentPosition
      ...
      : function (a, b) {
          ...
          if (
            ...
            (d = 9 === b.nodeType ? b : b.ownerDocument),
            a === b)
          )
            return 0;
          ...
          if (
            2 === a.nodeType &&
            a.childNodes &&
            -1 !== wysihtml5.lang.array(a.childNodes).indexOf(b)
          )
            return 20;
          if (
            2 === b.nodeType &&
            b.childNodes &&
            -1 !== wysihtml5.lang.array(b.childNodes).indexOf(a)
          )
            return 10;
          for (e = a, f = [], g = null; e; ) {
            if (e == b) return 10;
  ...
  (wysihtml5.dom.getPastedHtml = function (a) {
    ...
    return (
      a.clipboardData &&
        (wysihtml5.lang.array(a.clipboardData.types).contains("text/html")
          ? (b = a.clipboardData.getData("text/html"))
          : wysihtml5.lang
              .array(a.clipboardData.types)
              .contains("text/plain") &&
            (b = wysihtml5.lang
              .string(a.clipboardData.getData("text/plain"))
              .escapeHTML(!0, !0))),
      b
    );
  }),
  ...
  (wysihtml5.quirks.cleanPastedHTML = (function () {
    var a = function (a) {
        ...
        for (d in f.tags)
          if (f.tags.hasOwnProperty(d) && f.tags[d].keep_styles)
            for (e in f.tags[d].keep_styles)
              f.tags[d].keep_styles.hasOwnProperty(e) &&
                c[e] &&
      ...
      c = function (a, b) {
        ...
        for (d = 0, e = a.length; e > d; d++)
          if (
            (a[d].condition || (c = a[d].set),
            a[d].condition && a[d].condition.test(b))
          )
            return a[d].set;
        return c;
      };
  ...
  (function (a) {
    ...
    a.quirks.getCorrectInnerHTML = function (c) {
      ...
      for (
        d = c.querySelectorAll("[href*='~'], [src*='~']"), h = 0, g = d.length;
        g > h;
        h++
      )
        (e = d[h].href || d[h].src),
  ...
  (wysihtml5.quirks.tableCellsSelection = function (a, b) {
    ...
    function d(c) {
      (l.start = c),
        (l.end = c),
        (l.cells = [c]),
        (l.table = k.getParentElement(l.start, { nodeName: ["TABLE"] })),
        l.table &&
          (e(),
          k.addClass(c, m),
          (n = k.observe(a, "mousemove", g)),
          (o = k.observe(a, "mouseup", h)),
    ...
    function g(a) {
      ...
      g &&
        l.table &&
        l.start &&
        ((d = k.getParentElement(g, { nodeName: ["TABLE"] })),
        d &&
          d === l.table &&
          (e(),
          (c = l.end),
          (l.end = g),
          (l.cells = k.table.getCellsBetween(l.start, g)),
          l.cells.length > 1 && b.composer.selection.deselect(),
          f(l.cells),
          l.end !== c &&
            b.fire("tableselectchange").fire("tableselectchange:composer")));
    }
    function h() {
      n.stop(),
        o.stop(),
    ...
    function i() {
      var c = k.observe(a.ownerDocument, "click", function (a) {
        c.stop(),
          k.getParentElement(a.target, { nodeName: ["TABLE"] }) != l.table &&
            (e(),
            (l.table = null),
            (l.start = null),
            (l.end = null),
    ...
    a.quirks.styleParser = {
          ...
          if (((i = m[m.length - 1]), b.test(i))) j = i.match(b);
            ...
            return (
              ...
              a.lang.array(j).map(function (a, b) {
                return 3 > b
                  ? 16 * parseInt(a, 16) + parseInt(a, 16)
                  : parseFloat(a);
              })
            );
          if (j)
      ...
      unparseColor: function (a, b) {
        if (b) {
          if ("hex" == b)
            return (
              a[0].toString(16).toUpperCase() +
              a[1].toString(16).toUpperCase() +
              a[2].toString(16).toUpperCase()
            );
          if ("hash" == b)
            return (
              "#" +
      ...
      if (!a.canSurroundContents())
        for (
          var b = a.commonAncestorContainer,
            d = c(b, a.startContainer),
            e = c(b, a.endContainer);
    ...
    a.Selection = Base.extend({
      constructor: function (a, b, c) {
        window.rangy.init(),
          ...
          (this.contain = b),
          (this.unselectableclassName = c || !1);
      },
      ...
      selectNode: function (b, c) {
        ...
        g ? d.selectNodeContents(b) : d.selectNode(b),
          g && i && f
            ? d.collapse(k)
            : g && i && (d.setStartAfter(b), d.setEndAfter(b)),
          this.setSelection(d);
      },
        ...
        return a &&
          ...
          : ((b = this.getSelection(this.doc)),
            b.focusNode === b.anchorNode
              ? b.focusNode
              : ((c = this.getRange(this.doc)),
                c ? c.commonAncestorContainer : this.doc.body));
      },
      ...
      getPreviousNode: function (b, c) {
        var d, e, f;
        return (
          b || ((d = this.getSelection()), (b = d.anchorNode)),
          b === this.contain
            ? !1
            : ((e = b.previousSibling),
              e === this.contain
                ? !1
                : (e && 3 !== e.nodeType && 1 !== e.nodeType
                    ? (e = this.getPreviousNode(e, c))
                    : e && 3 === e.nodeType && /^\s*$/.test(e.textContent)
                      ? (e = this.getPreviousNode(e, c))
                      : c &&
                          e &&
                          1 === e.nodeType &&
      ...
      getSelectionParentsByTag: function () {
        ...
        for (c = 0, d = e.length; d > c; c++)
          (b =
            e[c].nodeName && "LI" === e[c].nodeName
              ? e[c]
              : a.dom.getParentElement(
                  e[c],
                  { nodeName: ["LI"] },
                  !1,
                  this.contain
      ...
      caretIsFirstInSelection: function () {
        var b = rangy.createRange(this.doc),
          ...
          d = this.getRange(),
          e = d.startContainer;
        return e.nodeType === a.TEXT_NODE
          ? this.isCollapsed() &&
              e.nodeType === a.TEXT_NODE &&
              /^\s*$/.test(e.data.substr(0, d.startOffset))
          : (b.selectNodeContents(this.getRange().commonAncestorContainer),
            b.collapse(!0),
            this.isCollapsed() &&
              (b.startContainer === c.anchorNode ||
                b.endContainer === c.anchorNode) &&
              b.startOffset === c.anchorOffset);
      },
      caretIsInTheBeginnig: function (b) {
        ...
        return b
          ? 0 === e &&
              ((d.nodeName && d.nodeName === b.toUpperCase()) ||
                a.dom.getParentElement(d.parentNode, { nodeName: b }, 1))
      ...
      executeAndRestore: function (b, c) {
        var d,
          ...
          r = '<span className="' + q + '">' + a.INVISIBLE_SPACE + "</span>",
          s = this.getRange(!0);
        if (!s) return b(n, n), void 0;
        s.collapsed ||
          ((k = s.cloneRange()),
          (j = k.createContextualFragment(r)),
          k.collapse(!1),
          k.insertNode(j),
          k.detach()),
          ...
          s.insertNode(i),
          j &&
            ((d = this.contain.querySelectorAll("." + q)),
            s.setStartBefore(d[0]),
            s.setEndAfter(d[d.length - 1])),
          this.setSelection(s);
        try {
        ...
        if (((d = this.contain.querySelectorAll("." + q)), d && d.length))
          for (
            l = rangy.createRange(this.doc),
              ...
              h && g
                ? (l.setStartBefore(g), l.setEndAfter(h))
                : ((f = this.doc.createTextNode(a.INVISIBLE_SPACE)),
                  e.insert(f).after(d[0]),
                  l.setStartBefore(f),
                  l.setEndAfter(f)),
              this.setSelection(l),
              m = d.length;
      ...
      deblockAndSurround: function (b) {
        ...
        if (
          ...
          this.composer.commands.exec("formatBlock", b.nodeName, b.className),
          (c = this.contain.querySelectorAll("." + b.className)),
          c[0])
        )
          for (
            c[0].parentNode.insertBefore(f, c[0]),
              g.setStartBefore(c[0]),
              g.setEndAfter(c[c.length - 1]),
              d = g.extractContents();
            d.firstChild;
            ...
            if (
              ((e = d.firstChild),
              1 == e.nodeType && a.dom.hasClass(e, b.className))
            ) {
              for (; e.firstChild; ) f.appendChild(e.firstChild);
              "BR" !== e.nodeName &&
                f.appendChild(this.doc.createElement("br")),
                d.removeChild(e);
      ...
      scrollIntoView: function () {
        ...
        f &&
          ...
          (c = b(g)),
          g.parentNode.removeChild(g),
          c >= d.body.scrollTop + d.documentElement.offsetHeight - e &&
            (d.body.scrollTop = c));
      },
      selectLine: function () {
      ...
      fixRangeOverflow: function (a) {
        var b, c;
        this.contain &&
          this.contain.firstChild &&
          a &&
          ((b = a.compareNode(this.contain)),
          2 !== b
            ? (1 === b && a.setStartBefore(this.contain.firstChild),
              0 === b && a.setEndAfter(this.contain.lastChild),
              3 === b &&
                (a.setStartBefore(this.contain.firstChild),
                a.setEndAfter(this.contain.lastChild)))
            : this._detectInlineRangeProblems(a) &&
              ((c = a.endContainer.previousElementSibling),
      ...
      getOwnRanges: function () {
        ...
        if (
          ...
          this.unselectableClass &&
            this.contain &&
            i &&
            ((b = this.getOwnUneditables()), b.length > 0))
        )
      ...
      isEndToEndInNode: function (b) {
        ...
        if (
          ...
          e.nodeType === a.TEXT_NODE &&
            !/^\s*$/.test(e.data.substr(c.startOffset)))
        )
          return !1;
        if (
          f.nodeType === a.TEXT_NODE &&
          !/^\s*$/.test(f.data.substr(c.endOffset))
        )
          return !1;
        for (; e && e !== d; ) {
  ...
  (function (a, b) {
    ...
    function e(a, b, c) {
      a.getAttribute("style")
        ? (h(a, c),
          a.getAttribute("style") && !/^\s*$/.test(a.getAttribute("style"))
            ? a.setAttribute("style", b + ";" + a.getAttribute("style"))
    ...
    function j(c, d, e, f) {
      return e
        ...
        : f
          ? a.dom.hasClass(c, f)
          : b.dom.arrayContains(d, c.tagName.toLowerCase());
    }
    function k(a, b, c, d) {
    ...
    function p(a, c) {
      return b.dom.isCharacterDataNode(a)
        ? 0 == c
          ? !!a.previousSibling
          : c == a.length
            ? !!a.nextSibling
            : !0
        : c > 0 && c < a.childNodes.length;
    }
    function q(a, c, d, e) {
      var f, g;
      if (
        (b.dom.isCharacterDataNode(c) &&
          (0 == d
            ? ((d = b.dom.getNodeIndex(c)), (c = c.parentNode))
            : d == c.length
              ? ((d = b.dom.getNodeIndex(c) + 1), (c = c.parentNode))
      ...
      doMerge: function () {
        ...
        for (d = 0, e = this.textNodes.length; e > d; ++d)
          (a = this.textNodes[d]),
            ...
            d &&
              (b.removeChild(a),
              b.hasChildNodes() || b.parentNode.removeChild(b));
      ...
      (s.prototype = {
        getAncestorWithClass: function (d) {
          for (var e; d; ) {
            if (
              ((e = this.cssClass
                ? c(d, this.cssClass, this.similarClassRegExp)
                : "" !== this.cssStyle
                  ? !1
                  : !0),
              d.nodeType == a.ELEMENT_NODE &&
                "false" != d.getAttribute("contenteditable") &&
                b.dom.arrayContains(this.tagNames, d.tagName.toLowerCase()) &&
                e)
            )
              return d;
            d = d.parentNode;
        ...
        getAncestorWithStyle: function (c) {
          for (var e; c; ) {
            if (
              ((e = this.cssStyle ? d(c, this.similarStyleRegExp) : !1),
              c.nodeType == a.ELEMENT_NODE &&
                "false" != c.getAttribute("contenteditable") &&
                b.dom.arrayContains(this.tagNames, c.tagName.toLowerCase()) &&
                e)
            )
              return c;
            c = c.parentNode;
        ...
        getMatchingAncestor: function (a) {
          ...
          return (
            b
              ? this.cssStyle && (c = "class")
              : ((b = this.getAncestorWithStyle(a)), b && (c = "style")),
            { element: b, type: c }
          );
        },
        postApply: function (a, b) {
          ...
          for (f = 0, g = a.length; g > f; ++f)
            (d = a[f]),
              ...
              d &&
                d.parentNode &&
                (e = this.getAdjacentMergeableTextNode(d.parentNode, !1)),
              e
                ? (c || ((c = new r(e)), k.push(c)),
                  c.textNodes.push(d),
                  d === i && ((l = c.firstTextNode), (n = l.length)),
                  d === j && ((m = c.firstTextNode), (o = c.getLength())))
                : (c = null);
          if (
            (j &&
              j.parentNode &&
              ((h = this.getAdjacentMergeableTextNode(j.parentNode, !0)),
              h && (c || ((c = new r(j)), k.push(c)), c.textNodes.push(h))),
            k.length)
          ) {
        ...
        createContainer: function (a) {
          ...
          return (
            this.cssClass && (b.className = this.cssClass),
        ...
        applyToTextNode: function (a) {
          ...
          b.dom.arrayContains(this.tagNames, d.tagName.toLowerCase())
            ? (this.cssClass && f(d, this.cssClass, this.similarClassRegExp),
              this.cssStyle && e(d, this.cssStyle, this.similarStyleRegExp))
            : ((c = this.createContainer(b.dom.getDocument(a))),
        ...
        isRemovable: function (c) {
          return (
            b.dom.arrayContains(this.tagNames, c.tagName.toLowerCase()) &&
            "" === a.lang.string(c.className).trim() &&
            (!c.getAttribute("style") ||
              "" === a.lang.string(c.getAttribute("style")).trim())
          );
        },
        undoToTextNode: function (a, b, c, d) {
          ...
          b.containsNode(h) ||
            ((e = b.cloneRange()),
            e.selectNode(h),
            e.isPointInRange(b.endContainer, b.endOffset) &&
              p(b.endContainer, b.endOffset) &&
              (q(h, b.endContainer, b.endOffset, this.container),
              b.setEndAfter(h)),
            e.isPointInRange(b.startContainer, b.startOffset) &&
              p(b.startContainer, b.startOffset) &&
              (h = q(h, b.startContainer, b.startOffset, this.container))),
            !f && this.similarClassRegExp && g(h, this.similarClassRegExp),
            f &&
              this.similarStyleRegExp &&
              (i = "change" === l(h, this.cssStyle, this.similarStyleRegExp)),
        ...
        applyToRange: function (b) {
          ...
          for (d = b.length; d--; ) {
            if (((c = b[d].getNodes([a.TEXT_NODE])), !c.length))
              try {
                return (
                  (e = this.createContainer(b[d].endContainer.ownerDocument)),
            ...
            if (
              (b[d].splitBoundaries(),
              (c = b[d].getNodes([a.TEXT_NODE])),
              c.length)
            ) {
              for (g = 0, h = c.length; h > g; ++g)
                (f = c[g]),
                  this.getMatchingAncestor(f).element ||
                    this.applyToTextNode(f);
              b[d].setStart(c[0], 0),
                (f = c[c.length - 1]),
          ...
          for (f = b.length; f--; ) {
            for (
              c = b[f].getNodes([a.TEXT_NODE]),
                c.length
                  ? (b[f].splitBoundaries(), (c = b[f].getNodes([a.TEXT_NODE])))
                  : ((g = b[f].endContainer.ownerDocument),
              ...
              b[f].isValid() &&
                ((d = c[i]),
                (e = this.getMatchingAncestor(d)),
                "style" === e.type
                  ? this.undoToTextNode(d, b[f], !1, e.element)
                  : e.element && this.undoToTextNode(d, b[f], e.element));
            1 == j
              ? this.selectNode(b[f], c[0])
              : (b[f].setStart(c[0], 0),
                (d = c[c.length - 1]),
                b[f].setEnd(d, d.length),
                this.normalize && this.postApply(c, b[f]));
          }
        },
        selectNode: function (b, c) {
          ...
          b.selectNodeContents(c),
            g && d
              ? b.collapse(!1)
              : g && (b.setStartAfter(c), b.setEndAfter(c));
        },
        ...
        isAppliedToRange: function (b) {
          ...
          for (e = b.length; e--; ) {
            if (((d = b[e].getNodes([a.TEXT_NODE])), !d.length))
              return (
                (c = this.getMatchingAncestor(b[e].startContainer).element),
                c ? { elements: [c], coverage: j } : !1
              );
            for (f = 0, g = d.length; g > f; ++f)
              (h = this.getTextSelectedByRange(d[f], b[e])),
                (c = this.getMatchingAncestor(d[f]).element),
                c && "" != h
                  ? (i.push(c),
                    1 === a.dom.getTextNodes(c, !0).length
                      ? (j = "full")
                      : "full" === j && (j = "inline"))
                  : c || (j = "partial");
          }
            ...
            ? "full" === c.coverage
              ...
              : "inline" === c.coverage
                ? ((b = k(
                  ...
                  this.undoToRange(a),
                  b || this.applyToRange(a))
                : (k(c.elements, this.tagNames, this.cssStyle, this.cssClass) ||
                    this.undoToRange(a),
                  this.applyToRange(a))
            : this.applyToRange(a);
        },
  ...
  (function (a) {
    function b(b, c) {
      var g,
        ...
        s = 0;
      for (
        a.commands.formatInline.exec(b, d, e, q, r, d, d, !0, !0),
          h = p.querySelectorAll(e + "." + q),
          g = h.length;
        g > s;
        s++
      ) {
      ...
      (l = i),
        1 === g &&
          ((m = f.getTextContent(i)),
          (j = !!i.querySelector("*")),
          (k = "" === m || m === a.INVISIBLE_SPACE),
          !j &&
            k &&
            (f.setTextContent(i, c.text || i.href),
            (n = p.createTextNode(" ")),
            b.selection.setAfter(i),
            f.insert(n).after(i),
            (l = n))),
  ...
  (function (a) {
    function b(a, b) {
      for (var d, e, f, g = b.length, h = 0; g > h; h++)
        (d = b[h]),
          (e = c.getParentElement(d, { nodeName: "code" })),
          (f = c.getTextContent(d)),
          f.match(c.autoLink.URL_REG_EXP) && !e
            ? (e = c.renameElement(d, "code"))
            : c.replaceWithChildNodes(d);
    }
    var c = a.dom;
  ...
  (function (a) {
    ...
    a.commands.fontSize = {
      exec: function (c, d, e) {
        a.commands.formatInline.execWithToggle(
          c,
          d,
          "span",
          "wysiwyg-font-size-" + e,
      ...
      state: function (c, d, e) {
        return a.commands.formatInline.state(
          c,
          d,
          "span",
          "wysiwyg-font-size-" + e,
    ...
    a.commands.fontSizeStyle = {
      ...
      stateValue: function (b, c) {
        var d,
          e = this.state(b, c);
        return (
          e && a.lang.object(e).isArray() && (e = e[0]),
          e && ((d = e.getAttribute("style")), d)
            ? a.quirks.styleParser.parseFontSize(d)
            : !1
        );
      },
    };
  ...
  (function (a) {
    ...
    a.commands.foreColorStyle = {
      exec: function (c, d, e) {
        var f,
          g = a.quirks.styleParser.parseColor(
            "object" == typeof e ? "color:" + e.color : "color:" + e,
            "color"
          );
        g &&
          ((f = "color: rgb(" + g[0] + "," + g[1] + "," + g[2] + ");"),
          1 !== g[3] &&
            (f +=
              "color: rgba(" +
              g[0] +
              ...
              g[3] +
              ");"),
          a.commands.formatInline.execWithToggle(c, d, "span", !1, !1, f, b));
      },
      state: function (c, d) {
      ...
      stateValue: function (b, c, d) {
        var e,
          f = this.state(b, c);
        return (
          f && a.lang.object(f).isArray() && (f = f[0]),
          f && ((e = f.getAttribute("style")), e && e)
            ? ((val = a.quirks.styleParser.parseColor(e, "color")),
              a.quirks.styleParser.unparseColor(val, d))
            : !1
        );
      },
    };
  ...
  (function (a) {
    ...
    a.commands.bgColorStyle = {
      ...
      stateValue: function (b, c, d) {
        ...
        return (
          f && a.lang.object(f).isArray() && (f = f[0]),
          f && ((e = f.getAttribute("style")), e)
            ? ((g = a.quirks.styleParser.parseColor(e, "background-color")),
              a.quirks.styleParser.unparseColor(g, d))
            : !1
        );
      },
    };
  ...
  (function (a) {
    function b(b, c, e) {
      b.className
        ? (d(b, e), (b.className = a.lang.string(b.className + " " + c).trim()))
        : (b.className = c);
    }
    function c(b, c, d) {
      e(b, d),
        b.getAttribute("style")
          ? b.setAttribute(
              "style",
              a.lang.string(b.getAttribute("style") + " " + c).trim()
            )
    ...
    function e(b, c) {
      ...
      return (
        b.setAttribute("style", (b.getAttribute("style") || "").replace(c, "")),
        "" == a.lang.string(b.getAttribute("style") || "").trim() &&
    ...
    a.commands.formatBlock = {
            ...
            ? (f.selection.executeAndRestoreRangy(function () {
                ...
                for (b = w.length; b--; ) {
                  if (
                    (o && (s = d(w[b], o)),
                    q && (u = e(w[b], q)),
                    (u || s) && null === m && w[b].nodeName != y)
                  )
                    return;
                  (c = i(w[b])),
                    (f = j(w[b])),
                    c || f || (!x && "P" !== m)
                      ? k.renameElement(w[b], "P" === m ? "DIV" : y)
                      : (a.dom.lineBreaks(w[b]).add(),
                        k.replaceWithChildNodes(w[b]));
                }
              }),
              void 0)
            : (((null !== m && !a.lang.array(l).contains(m)) ||
                ((r = f.selection
                  .findNodesInSelection(l)
                  .concat(f.selection.getSelectedOwnNodes())),
                f.selection.executeAndRestoreRangy(function () {
                  for (var a = r.length; a--; )
                    (v = k.getParentElement(r[a], { nodeName: l })),
                      v == f.element && (v = null),
                      v &&
                        (m && (v = k.renameElement(v, m)),
                        n && b(v, n, o),
                        p && c(v, p, q),
                        (t = !0));
                }),
      ...
      state: function (b, c, d, e, f, g, h) {
        var i,
          ...
          n = [];
        for (
          d = "string" == typeof d ? d.toUpperCase() : d, j = 0, l = m.length;
          l > j;
          j++
        )
  ...
  (wysihtml5.commands.formatCode = {
    ...
    state: function (a) {
      ...
      return b &&
        ...
        "PRE" == b.nodeName &&
        b.firstChild &&
        b.firstChild.nodeName &&
        "CODE" == b.firstChild.nodeName
        ? b
        : wysihtml5.dom.getParentElement(b, { nodeName: "CODE" }) &&
            wysihtml5.dom.getParentElement(b, { nodeName: "PRE" });
    },
  }),
  (function (a) {
    function b(a) {
    ...
    a.commands.formatInline = {
          ...
          ? (a.selection.getSelection().removeAllRanges(),
            ...
            i
              ...
              : (k.setStart(l[0].startContainer, l[0].startOffset),
                k.setEnd(
                  l[l.length - 1].endContainer,
                  l[l.length - 1].endOffset
                ),
      ...
      execWithToggle: function (b, c, d, e, f, g, h) {
        var i,
          j = this;
        this.state(b, c, d, e, f, g, h) &&
        b.selection.isCollapsed() &&
        !b.selection.caretIsLastInSelection() &&
        !b.selection.caretIsFirstInSelection()
      ...
      state: function (b, e, f, g, h, i, j) {
        var k,
          ...
          m = b.doc,
          n = d[f] || f;
        return a.dom.hasElementWithTagName(m, f) ||
          a.dom.hasElementWithTagName(m, n)
          ? g && !a.dom.hasElementWithClassName(m, g)
            ? !1
            : ((k = b.selection.getOwnRanges()),
              k && 0 !== k.length
                ? ((l = c(f, g, h, i, j, b.element).isAppliedToRange(k)),
                  l && l.elements ? l.elements : !1)
                : !1)
          : !1;
      },
    };
    ...
    a.commands.insertBlockQuote = {
      exec: function (b, c) {
        var d = this.state(b, c),
          e = b.selection.isEndToEndInNode([
            "H1",
            "H2",
            "H3",
            "H4",
        ...
        b.selection.executeAndRestore(function () {
          if (d)
            b.config.useLineBreaks && a.dom.lineBreaks(d).add(),
              a.dom.unwrap(d);
  ...
  (wysihtml5.commands.insertHTML = {
    exec: function (a, b, c) {
      a.commands.support(b)
        ? a.doc.execCommand(b, !1, c)
      ...
      exec: function (c, d, e) {
        ...
        if (
          ...
          return (
            ...
            "A" !== i.nodeName ||
              i.firstChild ||
              (c.selection.setAfter(i), i.parentNode.removeChild(i)),
        ...
        c.selection.insertNode(g),
          a.browser.hasProblemsSettingCaretAfterImg()
            ? ((h = f.createTextNode(a.INVISIBLE_SPACE)),
              c.selection.insertNode(h),
              c.selection.setAfter(h))
  ...
  (function (a) {
    ...
    a.commands.insertLineBreak = {
      exec: function (c, d) {
        c.commands.support(d)
          ? (c.doc.execCommand(d, !1, null),
            a.browser.autoScrollsToCaret() || c.selection.scrollIntoView())
          : c.commands.exec("insertHTML", b);
      },
      state: function () {
        return !1;
      },
  ...
  (wysihtml5.commands.insertList = (function (a) {
    var b = function (a, b) {
      ...
      c = function (c, d, e) {
        ...
        return (
          c &&
            ((f = a.dom.getParentElement(c, { nodeName: "LI" })),
            (g = "UL" === d ? "OL" : "UL"),
            b(c, d)
              ? (h.el = c)
              : b(c, g)
      ...
      g = function (b, c) {
        c.selection.executeAndRestoreRangy(function () {
          ...
          (g.innerHTML = g.innerHTML.replace(h, "")),
            g &&
              ((d = a.lang
                .array(["", "<br>", a.INVISIBLE_SPACE])
                .contains(g.innerHTML)),
              (e = a.dom.convertToList(
                g,
                b.toLowerCase(),
                c.parent.config.uneditableContainerClassname
              )),
      ...
      exec: function (a, b, f) {
        ...
        k.el
          ? k.other
            ? e(k.el, f, a)
            : d(k.el, f, a)
          : a.commands.support(i)
            ? h.execCommand(i, !1, null)
            : g(f, a);
      },
  ...
  (function (a) {
    ...
    a.commands.alignRightStyle = {
      exec: function (d) {
        return a.commands.formatBlock.exec(
          d,
          "formatBlock",
          null,
          null,
      ...
      state: function (d) {
        return a.commands.formatBlock.state(
          d,
          "formatBlock",
          null,
          null,
  ...
  (wysihtml5.commands.createTable = {
    exec: function (a, b, c) {
      ...
      if (
        ...
        c.cols &&
        c.rows &&
        parseInt(c.cols, 10) > 0 &&
        parseInt(c.rows, 10) > 0
      ) {
        for (
          f = c.tableStyle ? '<table style="' + c.tableStyle + '">' : "<table>",
            f += "<tbody>",
            e = 0;
          e < c.rows;
          e++
  ...
  (wysihtml5.commands.mergeTableCells = {
    exec: function (a, b) {
      a.tableSelection &&
        ...
        (this.state(a, b)
          ? wysihtml5.dom.table.unmergeCell(a.tableSelection.start)
    ...
    state: function (a) {
      if (a.tableSelection) {
        ...
        if (
          ...
          c &&
          b == c &&
          ((wysihtml5.dom.getAttribute(b, "colspan") &&
            parseInt(wysihtml5.dom.getAttribute(b, "colspan"), 10) > 1) ||
            (wysihtml5.dom.getAttribute(b, "rowspan") &&
              parseInt(wysihtml5.dom.getAttribute(b, "rowspan"), 10) > 1))
        )
          return [b];
      }
      return !1;
  ...
  (wysihtml5.commands.addTableCells = {
    exec: function (a, b, c) {
      if (a.tableSelection && a.tableSelection.start && a.tableSelection.end) {
        var d = wysihtml5.dom.table.orderSelectionEnds(
          a.tableSelection.start,
          a.tableSelection.end
        );
        "before" == c || "above" == c
          ? wysihtml5.dom.table.addCells(d.start, c)
          : ("after" == c || "below" == c) &&
            wysihtml5.dom.table.addCells(d.end, c),
          setTimeout(function () {
  ...
  (wysihtml5.commands.deleteTableCells = {
    exec: function (a, b, c) {
      if (a.tableSelection && a.tableSelection.start && a.tableSelection.end) {
        var d,
          e = wysihtml5.dom.table.orderSelectionEnds(
            a.tableSelection.start,
            a.tableSelection.end
          ),
        ...
        wysihtml5.dom.table.removeCells(e.start, c),
          setTimeout(function () {
            (d = wysihtml5.dom.table.findCell(g, f)),
              d ||
                ("row" == c &&
                  (d = wysihtml5.dom.table.findCell(g, {
                    row: f.row - 1,
                    col: f.col,
                  })),
                "column" == c &&
        ...
        b.executeAndRestoreRangy(function () {
          for (var b = a.length; b--; )
            (f = a[b]),
              ...
              e &&
                (g ? g.appendChild(f) : (d.appendChild(f), e.appendChild(d)),
                (h = !0));
        }),
        h
      );
        ...
        b.selection.executeAndRestoreRangy(function () {
          ...
          for (j = a.length; j--; )
            if (
              ((f = a[j]),
              f.parentNode &&
                ((c = f.parentNode), "OL" === c.tagName || "UL" === c.tagName))
            ) {
              if (
                ((h = !0),
                (d = wysihtml5.dom.getParentElement(
                  c.parentNode,
                  { nodeName: ["OL", "UL"] },
                  !1,
                  b.element
                )),
                (e = wysihtml5.dom.getParentElement(
                  c.parentNode,
                  { nodeName: ["LI"] },
                  !1,
                  b.element
                ...
                for (
                  f.nextSibling &&
                    ((g = i.getAfterList(c, f)), f.appendChild(g)),
  ...
  (function (a) {
    var b = 90,
      ...
      i =
        ('<span id="_wysihtml5-undo" className="_wysihtml5-temp">' +
          a.INVISIBLE_SPACE +
          "</span>",
        '<span id="_wysihtml5-redo" className="_wysihtml5-temp">' +
          a.INVISIBLE_SPACE +
          "</span>",
        a.dom);
      ...
      _observe: function () {
        ...
        i.observe(this.element, "keydown", function (a) {
          if (!a.altKey && (a.ctrlKey || a.metaKey)) {
            ...
            e
              ? (f.undo(), a.preventDefault())
              : g && (f.redo(), a.preventDefault());
          }
        }),
      ...
      transact: function () {
        ...
        m !== l &&
          ...
          n &&
            ...
            c.nodeType === a.ELEMENT_NODE
              ? (e = c)
              : ((e = c.parentNode), (i = this.getChildNodeIndex(e, c))),
            e.setAttribute(h, d),
            void 0 !== i && e.setAttribute(g, i)),
          (k = this.element.cloneNode(!!m)),
          this.historyDom.push(k),
          this.historyStr.push(m),
          e && (e.removeAttribute(h), e.removeAttribute(g)));
      },
      undo: function () {
        this.transact(),
          this.undoPossible() &&
  ...
  (function (a) {
    ...
    a.views.Composer = a.views.View.extend({
      ...
      getValue: function (b, c) {
        var d = this.isEmpty()
          ? ""
          : a.quirks.getCorrectInnerHTML(this.element);
      ...
      _create: function () {
        ...
        (this.doc = this.sandbox.getDocument()),
          ...
          (this.selection = new a.Selection(
            this.parent,
            this.element,
          ...
          (d = this.config.name),
          d &&
            (b.addClass(this.element, d),
            this.config.contentEditableMode ||
              b.addClass(this.editableArea, d)),
          this.enable(),
          !this.config.noTextarea &&
            this.textarea.element.disabled &&
            this.disable(),
          ...
          c.clearsContentEditableCorrectly() ||
            a.quirks.ensureProperClearing(this),
              ...
              (this.parent.on("newword:composer", function () {
                b.getTextContent(g.element).match(b.autoLink.URL_REG_EXP) &&
                  g.selection.executeAndRestore(function (c, d) {
                    var e,
                      f = g.element.querySelectorAll(
                        "." + g.config.uneditableContainerClassname
                      ),
                      h = !1;
                    for (e = f.length; e--; )
                      a.dom.contains(f[e], d) && (h = !0);
                    h ||
                      b.autoLink(d.parentNode, [
                        g.config.uneditableContainerClassname,
                      ]);
                  });
              }),
        ...
        this.config.useLineBreaks ||
            ...
            if (e.isEmpty()) {
              ...
              (e.element.innerHTML = ""),
                ...
                c.displaysCaretInEmptyContentEditableCorrectly()
                  ...
                  : ((a.innerHTML = "<br>"),
                    e.selection.setBefore(a.firstChild));
            }
          }),
          b.observe(this.element, "keydown", function (c) {
            ...
            if (!c.shiftKey && (i === a.ENTER_KEY || i === a.BACKSPACE_KEY))
              return (
                (h = b.getParentElement(
                  e.selection.getSelectedNode(),
                  { nodeName: f },
                  4
                )),
                h
                  ? (setTimeout(function () {
                      ...
                      if ("LI" === h.nodeName) {
                        if (!f) return;
                        (c = b.getParentElement(f, { nodeName: g }, 2)),
                          c || d(f);
                      }
  ...
  (function (a) {
    ...
    a.views.Composer.prototype.style = function () {
      ...
      return (
        ...
        ((m.getAttribute("rows") && "auto" === b.getStyle("height").from(m)) ||
          (m.getAttribute("cols") && "auto" === b.getStyle("width").from(m))) &&
          (m.style.display = d = p),
        b
          .copyStyles(g)
          .from(m)
  ...
  (function (a) {
    var b = a.dom,
      ...
      f = function (a, b, c, d) {
        var f, g, h;
        b.isCollapsed()
          ? b.caretIsInTheBeginnig("LI")
            ? (a.preventDefault(), d.commands.exec("outdentList"))
            : b.caretIsInTheBeginnig()
              ? a.preventDefault()
              : (b.caretIsFirstInSelection() &&
                  b.getPreviousNode() &&
                  b.getPreviousNode().nodeName &&
                  /^H\d$/gi.test(b.getPreviousNode().nodeName) &&
                  ((f = b.getPreviousNode()),
                  a.preventDefault(),
                  /^\s*$/.test(f.textContent || f.innerText)
                    ? f.parentNode.removeChild(f)
                    : ((g = f.ownerDocument.createRange()),
                      g.selectNodeContents(f),
                      g.collapse(!1),
                      b.setSelection(g))),
                (h = b.caretIsBeforeUneditable()),
                h && (a.preventDefault(), e(b, h, c)))
          : b.containsUneditable() && (a.preventDefault(), b.deleteContents());
      },
      g = function (a) {
        if (a.selection.isCollapsed()) {
          if (
            a.selection.caretIsInTheBeginnig("LI") &&
            a.commands.exec("indentList")
          )
            return;
    ...
    a.views.Composer.prototype.observe = function () {
      var e,
        ...
        i = this,
        j = this.getValue(!1, !1),
        k = this.sandbox.getIframe
          ? this.sandbox.getIframe()
          : this.sandbox.getContentEditable(),
        l = this.element,
        m =
          c.supportsEventsInIframeCorrectly() || this.sandbox.getContentEditable
            ? l
      ...
      b.observe(k, "DOMNodeRemoved", function () {
        ...
        c.supportsMutationEvents() ||
          (e = setInterval(function () {
            b.contains(document.documentElement, k) ||
              (clearInterval(e), i.parent.fire("destroy:composer"));
          }, 250)),
        ...
        this.config.handleTables &&
          (!this.tableClickHandle &&
            ...
            (this.sandbox.getIframe
              ? (this.tableClickHandle = b.observe(
                  k,
        ...
        b.observe(m, "blur", function (a) {
          if (j !== i.getValue(!1, !1)) {
            ...
            "function" == typeof Object.create &&
              (b = Object.create(a, { type: { value: "change" } })),
          ...
          b.observe(l, "copy", function (a) {
            a.clipboardData &&
              (a.clipboardData.setData(
                "text/html",
                i.config.copyedFromMarking + i.selection.getHtml()
              ),
              a.preventDefault()),
              i.parent.fire(a.type, a).fire(a.type + ":composer", a);
          }),
          ...
          b.observe(l, "mousedown", function (b) {
            var c = b.target,
              ...
              e = l.querySelectorAll(
                "." + i.config.uneditableContainerClassname + " img"
              ),
              f = a.lang.array(d).without(e);
            "IMG" === c.nodeName &&
              a.lang.array(f).contains(c) &&
              i.selection.selectNode(c);
          }),
        c.canSelectImagesInContentEditable() ||
            ...
            if (a.metaKey || a.ctrlKey) {
              ...
              (37 === b || 39 === b) &&
                (37 === b &&
                  ...
                  a.shiftKey || d.collapseToStart()),
                39 === b &&
                  (d.modify("extend", "right", "lineboundary"),
                  a.shiftKey || d.collapseToEnd()),
                a.preventDefault());
            }
          }),
        b.observe(l, "keydown", function (a) {
          ...
          (a.ctrlKey || a.metaKey) &&
            !a.altKey &&
            c &&
            (i.commands.exec(c), a.preventDefault()),
            8 === b
              ? f(a, i.selection, l, i)
              : i.config.handleTabKey &&
                9 === b &&
                (a.preventDefault(), g(i, l));
        }),
        ...
        b.observe(l, "mouseover", function (a) {
          var b,
            ...
            e = d.nodeName;
          ("A" === e || "IMG" === e) &&
            ((c = d.hasAttribute("title")),
            c ||
              ((b = h[e] + (d.getAttribute("href") || d.getAttribute("src"))),
    ...
    a.views.Synchronizer = Base.extend({
      ...
      fromComposerToTextarea: function (b) {
        this.textarea.setValue(
          a.lang.string(this.composer.getValue(!1, !1)).trim(),
          b
        );
      },
      fromTextareaToComposer: function (a) {
        ...
        b
          ? this.composer.setValue(b, a)
          : (this.composer.clear(), this.editor.fire("set_placeholder"));
      },
      sync: function (a) {
        "textarea" === this.editor.currentView.name
          ? this.fromTextareaToComposer(a)
          : this.fromComposerToTextarea(a);
      },
      _observe: function () {
        var c,
          d = this,
  ...
  (function (a) {
    ...
    a.Editor = a.lang.Dispatcher.extend({
      constructor: function (b, d) {
        if (
          ((this.editableElement =
            "string" == typeof b ? document.getElementById(b) : b),
          ...
          "textarea" != this.editableElement.nodeName.toLowerCase() &&
            ((this.config.contentEditableMode = !0),
            (this.config.noTextarea = !0)),
          this.config.noTextarea ||
            ((this.textarea = new a.views.Textarea(
              this,
              this.editableElement,
              this.config
            )),
        ...
        a.dom.addClass(document.body, this.config.bodyClassName),
          (this.composer = new a.views.Composer(
            this,
            this.editableElement,
            this.config
          )),
      ...
      handleBeforeLoad: function () {
        this.config.noTextarea ||
          (this.synchronizer = new a.views.Synchronizer(
            this,
            this.textarea,
            this.composer
          )),
          this.config.toolbar &&
            (this.toolbar = new a.toolbar.Toolbar(
              this,
              this.config.toolbar,
      ...
      parse: function (b, c) {
        var d = this.config.contentEditableMode
            ? document
            : this.composer
              ? this.composer.sandbox.getDocument()
              : null,
            ...
            b !== g &&
              ((a && "hidden" === b.type) ||
                ...
                (d =
                  ...
                  "boolean" != typeof this.elementToChange
  ...
  (function (a) {
    ...
    a.toolbar.Toolbar = Base.extend({
      constructor: function (f, g, h) {
        (this.editor = f),
          (this.container =
            "string" == typeof g ? document.getElementById(g) : g),
          (this.composer = f.composer),
          this._getLinks("command"),
          this._getLinks("action"),
          this._observe(),
          h && this.show(),
          null != f.config.classNameCommandDisabled &&
            (b = f.config.classNameCommandDisabled),
          null != f.config.classNameCommandsDisabled &&
            (c = f.config.classNameCommandsDisabled),
          null != f.config.classNameCommandActive &&
            (d = f.config.classNameCommandActive),
          null != f.config.classNameActionActive &&
      ...
      _getLinks: function (b) {
        for (
          var c,
            ...
            f,
            g,
            h = (this[b + "Links"] = a.lang
              .array(
                this.container.querySelectorAll("[data-wysihtml5-" + b + "]")
              )
              .get()),
            i = h.length,
            j = 0,
      ...
      _getDialog: function (b, c) {
        var d,
          ...
          g = this.container.querySelector(
            "[data-wysihtml5-dialog='" + c + "']"
          );
        return (
          g &&
            ((d = a.toolbar["Dialog_" + c]
              ? new a.toolbar["Dialog_" + c](b, g)
              : new a.toolbar.Dialog(b, g)),
            d.on("show", function () {
      ...
      _observe: function () {
        for (
          ...
          "A" === e[h].nodeName
            ? f
                .setAttributes({ href: "javascript:;", unselectable: "on" })
                .on(e[h])
            : f.setAttributes({ unselectable: "on" }).on(e[h]);
        f.delegate(
          d,
      ...
      _updateLinkStates: function () {
        ...
        for (c in j)
          (i = j[c]),
            this.commandsDisabled
              ? ((g = !1),
                f.removeClass(i.link, d),
                i.group && f.removeClass(i.group, d),
                i.dialog && i.dialog.hide())
              : ((g = this.composer.commands.state(i.name, i.value)),
                f.removeClass(i.link, b),
                i.group && f.removeClass(i.group, b)),
            i.state !== g &&
              ((i.state = g),
              g
                ? (f.addClass(i.link, d),
                  i.group && f.addClass(i.group, d),
                  i.dialog &&
                    ("object" == typeof g || a.lang.object(g).isArray()
                      ? (!i.dialog.multiselect &&
                          a.lang.object(g).isArray() &&
                          ((g = 1 === g.length ? g[0] : !0), (i.state = g)),
                        i.dialog.show(g))
                      : i.dialog.hide()))
                : (f.removeClass(i.link, d),
                  i.group && f.removeClass(i.group, d),
        ...
        for (c in k)
          (h = k[c]),
            "change_view" === h.name &&
              ((h.state = this.editor.currentView === this.editor.textarea),
              h.state ? f.addClass(h.link, e) : f.removeClass(h.link, e));
      },
      show: function () {
        this.container.style.display = "";
      },
  ...
  (function (a) {
    ...
    a.toolbar.Dialog_foreColorStyle = a.toolbar.Dialog.extend({
      ...
      _serialize: function () {
        for (
          var a = {},
            d = this.container.querySelectorAll(b),
            e = d.length,
            f = 0;
          e > f;
          f++
      ...
      _interpolate: function (d) {
        for (
          var e,
            ...
            l = k ? a.quirks.styleParser.parseColor(k, "color") : null;
          h > i;
          i++
        )
          (e = g[i]),
      ...
      b = (function (a) {
        ...
        return (
          ...
          g(/x/) &&
            (g = function (a) {
              return (
                "function" == typeof a && "[object Function]" === f.call(a)
              );
            }),
          (i.isFunction = g),
          (h =
        ...
        function a(a, b) {
          ...
          for (
            b &&
              ...
              e = Error.prototype.constructor.call(this, a),
              f = 0;
            f < c.length;
            f++
          )
        ...
        function d(a) {
          a.registerHelper("helperMissing", function (a) {
            ...
            a.registerHelper("each", function (a, b) {
              ...
              if (
                ...
                if (h(a))
                  ...
                  for (e in a)
                    a.hasOwnProperty(e) &&
                      (c && ((c.key = e), (c.index = j), (c.first = 0 === j)),
                      (k += f(a[e], { data: c })),
                      j++);
            ...
            a.registerHelper("if", function (a, b) {
              return (
                i(a) && (a = a.call(this)),
                (!b.hash.includeZero && !a) || o.isEmpty(a)
                  ? b.inverse(this)
                  : b.fn(this)
              );
            }),
            ...
            a.registerHelper("with", function (a, b) {
              return (
                i(a) && (a = a.call(this)), o.isEmpty(a) ? void 0 : b.fn(a)
              );
            }),
      ...
      e = (function (a, b, c) {
        ...
        function e(a, b) {
          ...
          var c = function (a, c, d, e, f, g) {
              ...
              if (b.compile)
                return (
                  (h = { helpers: e, partials: f, data: g }),
                  (f[c] = b.compile(a, { data: void 0 !== g }, b)),
                  f[c](d, h)
                );
              throw new l(
                "The partial " +
            ...
            d = {
              ...
              program: function (a, b, c) {
                ...
                return (
                  c ? (d = g(a, b, c)) : d || (d = this.programs[a] = g(a, b)),
                  d
                );
              },
              merge: function (a, b) {
    ...
    function (a, b, c, d, e) {
      function f(a) {
        ...
        return (
          (c +=
            ...
            l(
              ((b = a && a.options),
              (b = null == b || b === !1 ? b : b.toolbar),
              (b = null == b || b === !1 ? b : b.size),
              typeof b === k ? b.apply(a) : b)
            )),
          c
        );
      }
      ...
      return (
        ...
        (i = c["if"].call(
          b,
          ((i = b && b.options),
          (i = null == i || i === !1 ? i : i.toolbar),
          null == i || i === !1 ? i : i.size),
          { hash: {}, inverse: m.noop, fn: m.program(1, f, e), data: e }
        )),
        (i || 0 === i) && (j += i),
        (j +=
  ...
  (this.wysihtml5.tpl.color = Handlebars.template(function (a, b, c, d, e) {
    ...
    return (
      ...
      (g = c["if"].call(
        b,
        ((g = b && b.options),
        (g = null == g || g === !1 ? g : g.toolbar),
        null == g || g === !1 ? g : g.size),
        { hash: {}, inverse: k.noop, fn: k.program(1, f, e), data: e }
      )),
      (g || 0 === g) && (h += g),
      (h +=
        ...
        j(
          ((g = b && b.locale),
          (g = null == g || g === !1 ? g : g.colours),
          (g = null == g || g === !1 ? g : g.black),
          typeof g === i ? g.apply(b) : g)
        ) +
        '</span>\n    <b className="caret"></b>\n  </a>\n  <ul className="dropdown-menu">\n    <li><div className="wysihtml5-colors" data-wysihtml5-command-value="black"></div><a className="wysihtml5-colors-title" data-wysihtml5-command="foreColor" data-wysihtml5-command-value="black">' +
        j(
          ((g = b && b.locale),
          (g = null == g || g === !1 ? g : g.colours),
          (g = null == g || g === !1 ? g : g.black),
        ...
        '</a></li>\n    <li><div className="wysihtml5-colors" data-wysihtml5-command-value="silver"></div><a className="wysihtml5-colors-title" data-wysihtml5-command="foreColor" data-wysihtml5-command-value="silver">' +
        j(
          ((g = b && b.locale),
          (g = null == g || g === !1 ? g : g.colours),
          (g = null == g || g === !1 ? g : g.silver),
          typeof g === i ? g.apply(b) : g)
        ) +
        '</a></li>\n    <li><div className="wysihtml5-colors" data-wysihtml5-command-value="gray"></div><a className="wysihtml5-colors-title" data-wysihtml5-command="foreColor" data-wysihtml5-command-value="gray">' +
        j(
          ((g = b && b.locale),
          (g = null == g || g === !1 ? g : g.colours),
          (g = null == g || g === !1 ? g : g.gray),
          typeof g === i ? g.apply(b) : g)
        ) +
        '</a></li>\n    <li><div className="wysihtml5-colors" data-wysihtml5-command-value="maroon"></div><a className="wysihtml5-colors-title" data-wysihtml5-command="foreColor" data-wysihtml5-command-value="maroon">' +
        j(
          ((g = b && b.locale),
          (g = null == g || g === !1 ? g : g.colours),
          (g = null == g || g === !1 ? g : g.maroon),
          typeof g === i ? g.apply(b) : g)
        ) +
        '</a></li>\n    <li><div className="wysihtml5-colors" data-wysihtml5-command-value="red"></div><a className="wysihtml5-colors-title" data-wysihtml5-command="foreColor" data-wysihtml5-command-value="red">' +
        j(
          ((g = b && b.locale),
          (g = null == g || g === !1 ? g : g.colours),
          (g = null == g || g === !1 ? g : g.red),
          typeof g === i ? g.apply(b) : g)
        ) +
        '</a></li>\n    <li><div className="wysihtml5-colors" data-wysihtml5-command-value="purple"></div><a className="wysihtml5-colors-title" data-wysihtml5-command="foreColor" data-wysihtml5-command-value="purple">' +
        j(
          ((g = b && b.locale),
          (g = null == g || g === !1 ? g : g.colours),
          (g = null == g || g === !1 ? g : g.purple),
          typeof g === i ? g.apply(b) : g)
        ) +
        '</a></li>\n    <li><div className="wysihtml5-colors" data-wysihtml5-command-value="green"></div><a className="wysihtml5-colors-title" data-wysihtml5-command="foreColor" data-wysihtml5-command-value="green">' +
        j(
          ((g = b && b.locale),
          (g = null == g || g === !1 ? g : g.colours),
          (g = null == g || g === !1 ? g : g.green),
          typeof g === i ? g.apply(b) : g)
        ) +
        '</a></li>\n    <li><div className="wysihtml5-colors" data-wysihtml5-command-value="olive"></div><a className="wysihtml5-colors-title" data-wysihtml5-command="foreColor" data-wysihtml5-command-value="olive">' +
        j(
          ((g = b && b.locale),
          (g = null == g || g === !1 ? g : g.colours),
          (g = null == g || g === !1 ? g : g.olive),
          typeof g === i ? g.apply(b) : g)
        ) +
        '</a></li>\n    <li><div className="wysihtml5-colors" data-wysihtml5-command-value="navy"></div><a className="wysihtml5-colors-title" data-wysihtml5-command="foreColor" data-wysihtml5-command-value="navy">' +
        j(
          ((g = b && b.locale),
          (g = null == g || g === !1 ? g : g.colours),
          (g = null == g || g === !1 ? g : g.navy),
          typeof g === i ? g.apply(b) : g)
        ) +
        '</a></li>\n    <li><div className="wysihtml5-colors" data-wysihtml5-command-value="blue"></div><a className="wysihtml5-colors-title" data-wysihtml5-command="foreColor" data-wysihtml5-command-value="blue">' +
        j(
          ((g = b && b.locale),
          (g = null == g || g === !1 ? g : g.colours),
          (g = null == g || g === !1 ? g : g.blue),
          typeof g === i ? g.apply(b) : g)
        ) +
        '</a></li>\n    <li><div className="wysihtml5-colors" data-wysihtml5-command-value="orange"></div><a className="wysihtml5-colors-title" data-wysihtml5-command="foreColor" data-wysihtml5-command-value="orange">' +
        j(
          ((g = b && b.locale),
          (g = null == g || g === !1 ? g : g.colours),
          (g = null == g || g === !1 ? g : g.orange),
          typeof g === i ? g.apply(b) : g)
        ) +
        "</a></li>\n  </ul>\n</li>\n"),
      h
  ...
  (this.wysihtml5.tpl.emphasis = Handlebars.template(function (a, b, c, d, e) {
    ...
    function g(a, b) {
      ...
      return (
        ...
        (d = c["if"].call(
          a,
          ((d = a && a.options),
          (d = null == d || d === !1 ? d : d.toolbar),
          null == d || d === !1 ? d : d.size),
          { hash: {}, inverse: l.noop, fn: l.program(1, f, b), data: b }
        )),
        (d || 0 === d) && (e += d),
        (e +=
          ...
          k(
            ((d = a && a.locale),
            (d = null == d || d === !1 ? d : d.emphasis),
            (d = null == d || d === !1 ? d : d.small),
            typeof d === j ? d.apply(a) : d)
          ) +
          "</a>\n    "),
        e
      );
    ...
    return (
      ...
      (h = c["if"].call(
        b,
        ((h = b && b.options),
        (h = null == h || h === !1 ? h : h.toolbar),
        null == h || h === !1 ? h : h.size),
        { hash: {}, inverse: l.noop, fn: l.program(1, f, e), data: e }
      )),
      (h || 0 === h) && (i += h),
      (i +=
        ...
        k(
          ((h = b && b.locale),
          (h = null == h || h === !1 ? h : h.emphasis),
          (h = null == h || h === !1 ? h : h.bold),
          typeof h === j ? h.apply(b) : h)
        ) +
        '</a>\n    <a className="btn '),
      (h = c["if"].call(
        b,
      ...
      (h = c["if"].call(
        ...
        (h = null == h || h === !1 ? h : h.toolbar),
        (h = null == h || h === !1 ? h : h.emphasis),
        null == h || h === !1 ? h : h.small),
        { hash: {}, inverse: l.noop, fn: l.program(3, g, e), data: e }
      )),
      (h || 0 === h) && (i += h),
      (i += "\n  </div>\n</li>\n"),
      i
    ...
    function (a, b, c, d, e) {
      ...
      return (
        ...
        (j +=
          ...
          l(
            ((i = b && b.locale),
            (i = null == i || i === !1 ? i : i.font_styles),
            (i = null == i || i === !1 ? i : i.normal),
            typeof i === k ? i.apply(b) : i)
          ) +
  ...
  (this.wysihtml5.tpl.html = Handlebars.template(function (a, b, c, d, e) {
    ...
    return (
      ...
      (j +=
        ...
        l(
          ((i = b && b.locale),
          (i = null == i || i === !1 ? i : i.html),
          (i = null == i || i === !1 ? i : i.edit),
          typeof i === k ? i.apply(b) : i)
        ) +
        '" tabindex="-1">\n      '),
      (i = c["if"].call(
  ...
  (this.wysihtml5.tpl.image = Handlebars.template(function (a, b, c, d, e) {
    ...
    return (
      ...
      (j = c["if"].call(
        b,
        ((j = b && b.options),
        (j = null == j || j === !1 ? j : j.toolbar),
        null == j || j === !1 ? j : j.smallmodals),
        { hash: {}, inverse: n.noop, fn: n.program(1, f, e), data: e }
      )),
      (j || 0 === j) && (k += j),
      (k +=
        ...
        m(
          ((j = b && b.locale),
          (j = null == j || j === !1 ? j : j.image),
          (j = null == j || j === !1 ? j : j.insert),
          typeof j === l ? j.apply(b) : j)
        ) +
        '</h3>\n        </div>\n        <div className="modal-body">\n          <div className="form-group">\n            <input value="http://" className="bootstrap-wysihtml5-insert-image-url form-control" data-wysihtml5-dialog-field="src">\n          </div> \n        </div>\n        <div className="modal-footer">\n          <a className="btn btn-default" data-dismiss="modal" data-wysihtml5-dialog-action="cancel" href="#">' +
        m(
          ((j = b && b.locale),
          (j = null == j || j === !1 ? j : j.image),
          (j = null == j || j === !1 ? j : j.cancel),
          typeof j === l ? j.apply(b) : j)
        ) +
        '</a>\n          <a className="btn btn-primary" data-dismiss="modal"  data-wysihtml5-dialog-action="save" href="#">' +
        m(
          ((j = b && b.locale),
          (j = null == j || j === !1 ? j : j.image),
          (j = null == j || j === !1 ? j : j.insert),
      ...
      (j = c["if"].call(
        ...
        (j = null == j || j === !1 ? j : j.toolbar),
        null == j || j === !1 ? j : j.size),
        { hash: {}, inverse: n.noop, fn: n.program(3, g, e), data: e }
      )),
      (j || 0 === j) && (k += j),
      (k +=
  ...
  (this.wysihtml5.tpl.link = Handlebars.template(function (a, b, c, d, e) {
    ...
    return (
      ...
      (k +=
        ...
        m(
          ((j = b && b.locale),
          (j = null == j || j === !1 ? j : j.link),
          (j = null == j || j === !1 ? j : j.insert),
          typeof j === l ? j.apply(b) : j)
        ) +
        '</h3>\n        </div>\n        <div className="modal-body">\n          <div className="form-group">\n            <input value="http://" className="bootstrap-wysihtml5-insert-link-url form-control" data-wysihtml5-dialog-field="href">\n          </div> \n          <div className="checkbox">\n            <label> \n              <input type="checkbox" className="bootstrap-wysihtml5-insert-link-target" checked>' +
        m(
          ((j = b && b.locale),
          (j = null == j || j === !1 ? j : j.link),
          (j = null == j || j === !1 ? j : j.target),
          typeof j === l ? j.apply(b) : j)
        ) +
        '\n            </label>\n          </div>\n        </div>\n        <div className="modal-footer">\n          <a className="btn btn-default" data-dismiss="modal" data-wysihtml5-dialog-action="cancel" href="#">' +
        m(
        ...
        '</a>\n          <a href="#" className="btn btn-primary" data-dismiss="modal" data-wysihtml5-dialog-action="save">' +
        m(
          ((j = b && b.locale),
          (j = null == j || j === !1 ? j : j.link),
          (j = null == j || j === !1 ? j : j.insert),
  ...
  (this.wysihtml5.tpl.lists = Handlebars.template(function (a, b, c, d, e) {
    ...
    return (
      ...
      (o = c["if"].call(
        b,
        ((o = b && b.options),
        (o = null == o || o === !1 ? o : o.toolbar),
        null == o || o === !1 ? o : o.size),
        { hash: {}, inverse: s.noop, fn: s.program(1, f, e), data: e }
      )),
      (o || 0 === o) && (p += o),
      (p +=
        ...
        r(
          ((o = b && b.locale),
          (o = null == o || o === !1 ? o : o.lists),
          (o = null == o || o === !1 ? o : o.unordered),
          typeof o === q ? o.apply(b) : o)
        ) +
        '" tabindex="-1">\n    '),
      (o = c["if"].call(
        b,
    ...
    var c = function (a, b) {
      var c,
        ...
        g = function (c, e) {
          ...
          for (g in f.customTemplates)
            f.customTemplates.hasOwnProperty(g) &&
              (b.tpl[g] = f.customTemplates[g]);
      ...
      (g.prototype = {
        ...
        initializeEditor: function (a, c) {
          ...
          if (
            (e.on("beforeload", this.syncBootstrapDialogEvents),
            e.on("beforeload", this.loadParserRules),
            e.composer.editableArea.contentDocument
              ? this.addMoreShortcuts(
                  e,
                  e.composer.editableArea.contentDocument.body ||
                    e.composer.editableArea.contentDocument,
                  c.shortcuts
                )
              : this.addMoreShortcuts(e, e.composer.editableArea, c.shortcuts),
            c && c.events)
          )
            for (d in c.events)
        ...
        syncBootstrapDialogEvents: function () {
          ...
          a
            ...
            this.on("change_view", function () {
              a(this.toolbar.container.children)
                .find("a.btn")
          ...
          return (
            j
              ...
              .click(function (b) {
                ...
                (void 0 === e || "true" === e) &&
                  i.toolbar.find(".current-font").text(f);
              }),
        ...
        addMoreShortcuts: function (a, c, d) {
          b.dom.observe(c, "keydown", function (c) {
            ...
            (c.ctrlKey || c.metaKey || c.altKey) &&
              g &&
              b.commands[g] &&
              ((e = a.toolbar.commandMapping[g + ":null"]),
              e && e.dialog && !e.state
                ? e.dialog.show()
                : b.commands[g].exec(a.composer, g),
              c.preventDefault());
          });
        },
      }),
        (c = {
          resetDefaults: function () {
            a.fn.wysihtml5.defaultOptions = a.extend(
              !0,
              {},
            ...
            parserRules: {
              ...
              tags: {
                ...
                a: {
                  ...
                  set_attributes: { target: "_blank", rel: "nofollow" },
                },
                span: 1,
                div: 1,
                small: 1,
        ...
        void 0 === a.fn.wysihtml5.defaultOptionsCache &&
          (a.fn.wysihtml5.defaultOptionsCache = a.extend(
            !0,
            {},
            a.fn.wysihtml5.defaultOptions
          )),
