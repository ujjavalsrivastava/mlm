...
<div class="page-title-home9">
                                    ...
                                    <div class="col-12">
                                        <div class="content">
                                            <div>
                                                ...
                                                <h1 class="fade-item fade-item-1 fw-7 " style={{textShadow: '0 2px black'}}>
                                                हुनर से शिखर तक
            ...
            <section class="section-about-box style-1 tf-spacing-23">
                <div class="tf-container">
                    <div class="row items-center">
                    <div class="col-md-6 col-lg-5">
                            <div class="content-wrap">
                                <div class="box-sub-tag" >
                                    <div class="sub-tag-icon">
                                        <i class="icon-flash"></i>
                                    </div>
                                    <div class="sub-tag-title">
                                ...
                                <h2 class="title-content fw-7 font-cardo" >
                                    <span class="tf-secondary-color">Digital Duniyaa</span> : Digital Income  <br/> Opportunities For Youth
                                </h2>
                                <p class="text-content" >
                                MD Digital Duniyaa Pvt. Ltd. helps young people find digital income opportunities by focusing on skill development. 
                                Join us to gain lifelong, skill-based education and explore business opportunities for a bright future.
                                </p>
                                <a class="tf-btn style-secondary"  href="#">Learn
                        ...
                        <div class=" col-md-6 col-lg-7">
                            <div class="box-img">
                                <div class="wrap-image-agent">
                                    <div class="image">
                                        <img class="lazyload" data-src="assets/images/about-img1.png"
                                            src="assets/images/about-img1.png" alt="" />
                                    </div>
                                </div>
                                <div class="wrap-images">
                                    <div class="image">
                                        <img class="lazyload" data-src="assets/images/about-2.jpg"
                                            src="assets/images/section/about-3.jpg" alt="" />
                                    </div>
                                    <div class="image">
                                        <img class="lazyload" data-src="assets/images/about-3.jpg"
                                            src="assets/images/section/about-4.jpg" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section class="section-why tf-spacing-23 pt-0">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="icons-box" >
                                ...
                                <div class="content">
                                    ...
                                    <p>Skill-Focused Training: 20,000+ professionals and <br/>
                        ...
                        <div class="col-sm-4">
                            <div class="icons-box " >
                                ...
                                <div class="content">
                                    ...
                                    <p>Empowering youth to earn multiple incomes <br/>
                        ...
                        <div class="col-sm-4">
                            <div class="icons-box " data-wow-delay="0.45s">
                                <div class="icons has-ellipse">
                                <svg width="50" height="61" viewBox="0 0 50 51" fill="none"
                                            ...
                                            <path
                                                ...
                                                fill="white" />
                                            <path d="M34.6296 19.3567H38.6487V35.0997H34.6296V19.3567Z"
                                                fill="#E9DECE" />
                                            <path
                                ...
                                <div class="content">
                                    ...
                                    <p>We have come to you with a focus on <br/>"Siksha" (Education), "Hunar" (Skills), and "Seva" (Service).
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <section class="section-course-style5 tf-spacing-11 bg-4">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
                            <div class="heading-section">
                                <h2 class="fw-7 font-cardo  animated" data-wow-delay="0.1s">Digital Entrepreneurship Bundles</h2>
                                <div class="flex items-center justify-between flex-wrap gap-10">
                                    <div class="sub fs-15 " data-wow-delay="0.2s">Outpace the competition with our course</div>
                                    
                                </div>
                            </div>
                            <div class="swiper-container slider-courses-5 " data-wow-delay="0.4s">
                                <div class="swiper-wrapper">
                                {product && product.map(row =>(
                                    ...
                                    <div class="swiper-slide">
                                        <div class="course-item hover-img style-2 h240">
                                            <div class="features image-wrap">
                                                <img class="lazyload" data-src="assets/images/courses/courses-02.jpg"
                                                    src="assets/images/courses/courses-02.jpg" alt="" />

                                            </div>
                                            <div class="content">

                                                <h5 class="fw-5 line-clamp-2">
                                                    <a href="course-single-v2.html">Advance Digital Marketing
                                                    </a>
                                                </h5>
                                                ...
                                                <div class="bottom">
                                                    <div class="h6 price fw-5">₹60,000</div>
                                                    <a href="course-single-v2.html" class="tf-btn-arrow"><span
                                                            class="fw-5 fs-15">Buy Now</span>
                                                        <i class="icon-arrow-top-right"></i></a>
                                                </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="course-item hover-img style-2 h240">
                                            <div class="features image-wrap">
                                                <img class="lazyload" data-src="assets/images/courses/courses-03.jpg"
                                                    src="assets/images/courses/courses-03.jpg" alt="" />
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="bottom">
                                                    <div class="h6 price fw-5">₹30,000</div>
                                                    <a href="course-single-v2.html" class="tf-btn-arrow"><span
                                                            class="fw-5 fs-15">Buy Now</span>
                                                        <i class="icon-arrow-top-right"></i></a>
                                                </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="course-item hover-img style-2 h240">
                                            <div class="features image-wrap">
                                                <img class="lazyload" data-src="assets/images/courses/courses-04.jpg"
                                                    src="assets/images/courses/courses-03.jpg" alt="" />
                                            ...
                                            <div class="content">
                                                ...
                                                <h5 class="fw-5 line-clamp-2">
                                                    <a href="course-single-v2.html">Social Media Growth Program</a>
                                                </h5>
                                                ...
                                                <div class="bottom">
                                                    <div class="h6 price fw-5">₹20,000</div>
                                                    <a href="course-single-v2.html" class="tf-btn-arrow"><span
                                                            class="fw-5 fs-15">Buy Now</span>
                                                        <i class="icon-arrow-top-right"></i></a>
                                                </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="course-item hover-img style-2 h240">
                                            <div class="features image-wrap">
                                                <img class="lazyload" data-src="assets/images/courses/courses-05.jpg"
                                                    src="assets/images/courses/courses-03.jpg" alt="" />
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="bottom">
                                                    <div class="h6 price fw-5">₹10,000</div>
                                                    <a href="course-single-v2.html" class="tf-btn-arrow"><span
                                                            class="fw-5 fs-15">Buy Now</span>
                                                        <i class="icon-arrow-top-right"></i></a>
                                                </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="course-item hover-img style-2 h240">
                                            <div class="features image-wrap">
                                                <img class="lazyload" data-src="assets/images/courses/courses-06.jpg"
                                                    src="assets/images/courses/courses-03.jpg" alt="" />
                                            ...
                                            <div class="content">
                                                ...
                                                <h5 class="fw-5 line-clamp-2">
                                                    <a href="course-single-v2.html">English Speaking</a>
                                                </h5>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="course-item hover-img style-2 h240">
                                            <div class="features image-wrap">
                                                <img class="lazyload" data-src="assets/images/courses/courses-07.jpg"
                                                    src="assets/images/courses/courses-03.jpg" alt="" />
                                            ...
                                            <div class="content">
                                                ...
                                                <h5 class="fw-5 line-clamp-2">
                                                    <a href="course-single-v2.html">Complete Web Creation</a>
                                                </h5>
                                                ...
                                                <div class="bottom">
                                                    <div class="h6 price fw-5">₹50,000</div>
                                                    <a href="course-single-v2.html" class="tf-btn-arrow"><span
                                                            class="fw-5 fs-15">Buy Now</span>
                                                        <i class="icon-arrow-top-right"></i></a>
                                                </div>
...
<div class="row ">
    <div class="col-12 d-flex justify-center">\
        <Link to={'/register'}>
<a href="#" class="tf-btn">Buy this bundle @ ₹2499 <i class="icon-arrow-top-right"></i></a>
</Link>
</div>
</div>
                    </div>  
                ...
                <div class="tf-container">
                    <div class="row">
                        <div class="wrap-icon-box">
                            <div class="icons-box style-3 " data-wow-delay="0.1s">
                                <div class="icons">
                            ...
                            <div class="icons-box style-3 " data-wow-delay="0.2s">
                                <div class="icons">
                            ...
                            <div class="icons-box style-3 " data-wow-delay="0.3s">
                                <div class="icons">
            ...
            <section class="section-academisc tf-spacing-11">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
                            <div class="heading-section text-center">
                                <h2 class="fw-7 font-cardo  animated" data-wow-delay="0.1s">Upcoming Academic Programs</h2>
                                <div class="sub fs-15 " data-wow-delay="0.2s">Unlock your future with our upskilling courses and endless growth opportunities.</div>
                            </div>
                            <div class="swiper-container slider-category" data-preview="3" data-space="28">
                                <div class="swiper-wrapper grid-sw-5">
                                    <div class="swiper-slide">
                                        <a href="#">
                                            <div class="academisc-item">
                                                <div class="image-wrap">
                                                    <img class=" ls-is-cached lazyloaded"
                                                        data-src="assets/images/section/academisc-1.jpg"
                                                        src="assets/images/section/academisc-1.jpg" alt=""/>
                                                </div>
                                                <div class="content">
                                                    <p>State wise 10th and 12th 
                                                    <br/> Coaching class</p>
                                                </div>
                                            </div>
                                        </a>
                                            ...
                                            <div class="academisc-item">
                                                <div class="image-wrap">
                                                    <img class=" ls-is-cached lazyloaded"
                                                        ...
                                                        src="assets/images/section/academisc-2.jpg" alt="" />
                                                </div>
                                                <div class="content">
                                                    <p>CBSE Board 10th and  <br/> 12th Class
                                                    </p>
                                                </div>
                                            </div>
                                        </a>
                                            ...
                                            <div class="academisc-item">
                                                <div class="image-wrap">
                                                    <img class=" ls-is-cached lazyloaded"
                                                        ...
                                                        src="assets/images/section/academisc-3.jpg" alt="" />
                                                </div>
                                                <div class="content">
                                                    <p>AI (Artificial Inteligence) <br/> special crack Course</p>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                            ...
                                            <div class="academisc-item">
                                                <div class="image-wrap">
                                                    <img class=" ls-is-cached lazyloaded"
                                                        ...
                                                        src="assets/images/section/academisc-4.jpg" alt="" />
                                                </div>
                                                <div class="content">
                                                    <p>Online <br/> Learning</p>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                            ...
                                            <div class="academisc-item">
                                                <div class="image-wrap">
                                                    <img class=" ls-is-cached lazyloaded"
                                                        ...
                                                        src="assets/images/section/academisc-5.jpg" alt="" />
                                                </div>
                                                <div class="content">
                                                    <p>Global <br/> Education</p>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="key-wrap flex">
                    <div class="key-image">
                        <img class="lazyload" data-src="assets/images/whychoose.jpg"
                            src="assets/images/whychoose.jpg" alt="" />
                    </div>
                    <div class="content  bg-4">
                    <h2 class="font-cardo fw-7  animated" data-wow-delay="0.1s">Why Choose Us?</h2>
                                <p class="" data-wow-delay="0.2s">Digital Duniyaa provides skill-based classes in Digital Marketing, Website Creation, Ads Campaigns, and more. Earn lakhs monthly with our unique income plan and free training from top trainees. 
                                    Join 20,000+ trained, including 1,000+ millionaires.</p>
                                <div class="tags " data-wow-delay="0.3s">
                                    <div class="tag">
                                        <i class="flaticon-check"></i>
                                        <span>Skill-Focused Training
                                        </span>
                                    </div>
                                    <div class="tag">
                                        <i class="flaticon-check"></i>
                                        <span>20,000+ Trained Professionals
                                        </span>
                                    </div>
                                    <div class="tag">
                                        <i class="flaticon-check"></i>
                                        <span>1,000 Millionaire Success Stories
                                        </span>
                                    </div>
                                    <div class="tag">
                                        <i class="flaticon-check"></i>
                                        <span>Earn Lakhs Each Month
                                        </span>
                                    </div>
                                    <div class="tag">
                                        <i class="flaticon-check"></i>
                                        <span>Exclusive Free Training by Our Top Trainees
                                        </span>
                                    </div>
                                </div>
                                <a href="#" class="tf-btn " data-wow-delay="0.4s">Join Today<i
                                        class="icon-arrow-top-right"></i>
                                </a>
            ...
            <section class="section-teachers-1 tf-spacing-23 pb-0">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="teachers-content">
                                <h2 class="title font-cardo fw-7 lesp-1  animated" data-wow-delay="0.1s">Meet <br/> 
                                <span class="tf-secondary-color">Our Founders </span>
                                </h2>
                                <p class="fs-15 " data-wow-delay="0.2s">Sir Devendra Maurya (Founder) and Miss Mahima Maurya <br/>
                        ...
                        <div class="col-md-6">
                            <div class="teachers-image">
                                <div class="teachers-upskill-wrap">
                                    <div class="teachers-upskill">
                                        <div class="image">
                                            <img class=" ls-is-cached lazyloaded"
                                                src="assets/images/devendra-founder.jpg"
                                                data-src="assets/images/devendra-founder.jpg" alt="" />
                                        </div>
                                    ...
                                    <div class="teachers-upskill">
                                        <div class="image">
                                            ...
                                            data-src="assets/images/mahima-founder.jpg"  alt="" />
                                        </div>
                                        <div class="name">
           ...
           <section class="section-faq-page tf-spacing-23 pb-0">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="page-faq-content faq-1 ">
                                ...
                                <div class="heading-section">
                                    <h2 class="font-cardo " data-wow-delay="0s">Frequently Asked Questions</h2>
                                    <p class="fs-15 " data-wow-delay="0s">Answers to the burning questions in your mind.</p>
                                </div>
                                <div class="tf-accordion-default tf-accordion " id="accordionExample">
                                    <div class="tf-accordion-item " data-wow-delay="0s">
                                    ...
                                    <div class="tf-accordion-item " data-wow-delay="0s">
                                        ...
                                        <div id="collapseTwo" class="tf-accordion-collapse collapse"
                                            ...
                                            <div class="tf-accordion-content">
                                                ...
                                                focusing on teaching them better ways to earn multiple streams of income. 
                                                In addition, it provides training in digital marketing skills to help young people thrive in the digital economy.
                                    ...
                                    <div class="tf-accordion-item " data-wow-delay="0s">
                                        ...
                                        <div id="collapseThree" class="tf-accordion-collapse collapse"
                                            ...
                                            <div class="tf-accordion-content">
                                                ...
                                                website creation, ads Campaigns, Social media marketing, and Sales Expert. Check out our courses section to know more.
                                    ...
                                    <div class="tf-accordion-item " data-wow-delay="0s">
                                        ...
                                        <div id="collapseFour" class="tf-accordion-collapse collapse"
                                            ...
                                            <div class="tf-accordion-content">
                                                ...
                                                with the Ministry of Corporate Affairs, Registrar of Companies (RoC) Kanpur. 
                                                All necessary information is available in detail on our website.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
            ...
            <section class="section-become-instructor bg-darksky pt-0 " data-wow-delay="0.2s">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="main-section">
                                <div class="content-inner">
                                    <h2 class="font-cardo fw-7">Business Opportunity</h2>
                                    <p class="fs-15">Digital Duniyaa empowers youth aged 15 to 35 to achieve 
                                        financial freedom and break free from job dependency, 
                                        enabling them to pursue their dreams independently.</p>
                                    <ul class="wrap-list-text-check1">
                                    ...
                                    <div class=" box-agent style2">
                                        <ul class="agent-img-list">
                                            <li class="agent-img-item">
                                                <img class="lazyload" data-src="assets/images/avatar/user-1.png"
                                                    src="assets/images/avatar/user-1.png" alt="" />
                                            </li>
                                            <li class="agent-img-item">
                                                <img class="lazyload" data-src="assets/images/avatar/user-2.png"
                                                    src="assets/images/avatar/user-2.png" alt="" />
                                            </li>
                                            <li class="agent-img-item">
                                                <img class="lazyload" data-src="assets/images/avatar/user-3.png"
                                                    src="assets/images/avatar/user-3.png" alt="" />
                                            </li>
                                            <li class="agent-img-item">
                                                <p>1M+</p>
                                            </li>
                                ...
                                <div class="content-img">
                                    <img class="lazyload item-1" data-src="assets/images/happy-man.png"
                                        src="assets/images/happy-man.png" alt="" />
                                    <img class="lazyload item-2" data-src="assets/images/item/item-4.png"
                                        src="assets/images/item/item-4.png" alt="" />
                                    <img class="lazyload item-3" data-src="assets/images/item/item-20.png"
                                        src="assets/images/item/item-20.png" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
