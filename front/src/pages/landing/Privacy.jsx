          ...
          <div className="row">
            <div className="col-12">
              <div className="content text-center">
                <h2 className="font-cardo fw-7">Privacy Policy</h2>
            ...
            <div className="row">
              <div className="col-12">
                <div className="content">
                  <h2 className="text-22 fw-5 font-outfit ">
                    PRIVACY STATEMENT
                  </h2>
                  <p>&#8212;-</p>
                  <p>
                  ...
                  <p>
                    ...
                    <strong>info@digitalduniyaa.in</strong> or mailing us at:{" "}
                    <strong>
                      MDDIGITAL DUNIYAA PRIVATE LIMITED Village &amp; Post
                      Chiraigaon, Varanasi- 221112, Uttar Pradesh, India.
                    </strong>
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    conditions of razorpay on https://razorpay.com
                  </p>
                  <p>
                  ...
                  <p>
                    We use cookies to maintain the session of your user. It is
                  ...
                  <p>
                    ...
                    <strong>info@digitalduniyaa.in</strong> or by mail at{" "}
                    <strong>
                      MDDIGITAL DUNIYAA PRIVATE LIMITED Village &amp; Post
                      Chiraigaon, Varanasi- 221112, Uttar Pradesh, India.
                    </strong>
