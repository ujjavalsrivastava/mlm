...
<div class="page-title page-title-terms">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="content text-center">
                            ...
                            <h2 class="font-cardo fw-7">Contact Us</h2>
            ...
            <div class="tf-spacing-24 pb-0">
              
                <section class="section-why tf-spacing-8 pt-0 page-contact">
                    <div class="tf-container">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="icons-box " data-wow-delay="0">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>MDDIGITAL DUNIYAA PRIVATE LIMITED<br />
                                        Village & Post Chiraigaon, Varanasi- 221112,<br/>
                                         Uttar Pradesh, India,
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="icons-box " data-wow-delay="0.2s">
                                    <div class="icons has-ellipse">
                                        <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                    ...
                                    <div class="content">
                                        ...
                                        <p>+91 9170355968 <br/> info@digitalduniyaa.in
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="icons-box " data-wow-delay="0.3s">
                                    <div class="icons has-ellipse">
                                        <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0_330_14218)">
                                                <path d="M24.2998 5.17389H33.0411V11.604H24.2998V5.17389Z"
                                                    fill="#FEFDFE" />
                                                <path
                                    ...
                                    <div class="content">
                                        ...
                                        <p>Monday - Friday: 09:00 AM - 06:30 PM
                                        </p>
                ...
                <div class="contact-wrap bg-white tf-spacing-26 pt-0">
                    <div class="tf-container">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="img-left">
                            ...
                            <div class="col-lg-6">
                                <div class="content-right">
                                    <h2 class="fw-7 " data-wow-delay="0">
                                        How Can We Help?
                                    </h2>
                                    <div class="register " data-wow-delay="0">
