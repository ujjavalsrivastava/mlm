  ...
  return (
    <React.Fragment>
      ...
      <main class="main-area fix">
        <div
          class="breadcrumb__area breadcrumb__bg breadcrumb__bg-two"
                ...
                <div class="courses__details-content">
                  ...
                  <div class="courses__details-meta">
                    <ul class="list-wrap">
                      ...
                      <li class="date">
                        <i class="flaticon-calendar"></i>24/07/2024
                      </li>
                      <li>
                        <i class="flaticon-mortarboard"></i>2,250 Students
                      </li>
                    </ul>
                  </div>
                    ...
                    >
                      <div class="courses__instructors-wrap">
                        ...
                        <div class="courses__instructors-content">
                          ...
                          <p class="avg-rating">
                            <i class="fas fa-star"></i>(4.8 Ratings)
                          </p>
                          <p>
                            Dorem ipsum dolor sit amet, consectetur adipiscing
                            elit, sed do eiusmod tempor incididunt ut labore et
